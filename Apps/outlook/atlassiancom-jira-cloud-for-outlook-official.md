---
title: Anwendungsinformationen für Jira Cloud für Outlook (offiziell) von Atlassian.com
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/26/2021
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Jira Cloud für Outlook (Offiziell), ihre Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "64881502"
---
# <a name="jira-cloud-for-outlook-official"></a>Jira Cloud für Outlook (offiziell)
...
* <a href="https://appsource.microsoft.com/product/office/WA200000056" target="_blank">Anzeigen in AppSource</a>
...
|:----------------|:-------------|
| App-Name | Jira Cloud für Outlook (offiziell) |
| ID | WA200000056 |
...
| Kernfunktionen der App | Software planen, nachverfolgen, freigeben. Verwalten sie Support, Kundendienst und Projekte. |
...
| Welche Daten werden von Ihrer App verarbeitet? | Benutzer-E-Mail-Daten werden als Teil der Anwendungsfunktion zum Anzeigen von Jira-Links verarbeitet. |

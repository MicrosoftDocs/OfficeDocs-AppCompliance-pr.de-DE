...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Quantum Workplace, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "66826081"
---
# <a name="quantum-workplace"></a>Quantenarbeitsplatz
...
* <a href="https://appsource.microsoft.com/product/office/WA104381747" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die Von Quantum Workplace an Microsoft bereitgestellt werden:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | Quantenarbeitsplatz |
| ID | WA104381747 |
| unterstützte Office 365 Clients | Outlook 2013 oder höher unter Windows, Outlook 2016 oder höher auf Mac, Outlook im Web |
| Name des Partnerunternehmens | Quantenarbeitsplatz |
...
| App-Infoseite | [https://www.quantumworkplace.com/product/employee-engagemen...](https://www.quantumworkplace.com/product/employee-engagement-software) |
...
| Neuestes SOC2-Zertifizierungsdatum | 2021-06-30 |
...
>| User.Read.All | Anwendung | User.Id (Gespeichert) – Wird verwendet, um Benutzer zu korrelieren, die an unseren Bot-Endpunkt gesendet wurden; User.UserPrincipalName (Nicht gespeichert) – derzeit nicht verwendet; User.Mail (Nicht gespeichert) – Wird verwendet, um Benutzer in unserem System mit ihrer gespeicherten AzureAD-ID abzugleichen. | [be93046b-63ab-4216-9bcc-78faa55eeaa7](../azure/be93046b-63ab-4216-9bcc-78faa55eeaa7.md) |

---
title: Application Information for Supermetrics by Supermetrics
ms.author: elmalova
author: elenamalova
ms.date: 10/22/2021
ms.topic: article
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Supermetrics, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://appsource.microsoft.com/product/office/WA104381807" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Supermetrics für Microsoft bereitgestellte Informationen:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | Supermetrics |
| ID | WA104381807 |
| unterstützte Office 365-Clients | Excel 2016 oder höher auf Windows, Excel 2016 oder höher auf Mac Excel im Web |
| Name des Partnerunternehmens | Supermetrics |
| Website des Unternehmens | [https://supermetrics.com](https://supermetrics.com) |
| Nutzungsbedingungen der App | [https://supermetrics.com/terms-of-service](https://supermetrics.com/terms-of-service) |
| Kernfunktionen der App | Mit Supermetrics können Unternehmen isolierte Daten aus mehr als 70 Marketing- und Vertriebsplattformen wie Facebook Ads, Google Analytics, Doppelklick und mehr aggregieren und die Daten zu Berichtzwecken direkt in Excel übertragen. Auf diese Weise können Sie: – Manuelle Datenimportaufgaben automatisieren; – Verwenden Sie die Formeln und Tools, die bereits in Excel verfügbar sind, um Ihre Marketingdaten zu analysieren und zu visualisieren; – Erhalten Sie das Gesamtbild, indem Sie mehrere Datenquellen direkt in Excel anzeigen. |
...
Diese Informationen wurden von Supermetrics darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden in Ihren Datenbanken gespeichert? | Name, E-Mail-Adresse, Kontaktinformationen |
...
| URL der Datenschutzrichtlinie | https://supermetrics.com/privacy-policy |
...
| Unterstützt Ihre App die fortlaufende Zugriffsauswertung (Continuous Access Evaluation, CAE) | Nein |

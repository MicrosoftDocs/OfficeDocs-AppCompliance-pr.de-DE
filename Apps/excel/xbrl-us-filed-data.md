---
title: Anwendungsinformationen für von XBRL USA eingereichte XBRL-Daten
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für archivierte XBRL-Daten, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "63543483"
---
# <a name="xbrl-filed-data"></a>Eingereichte XBRL-Daten

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: August 2, 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002591" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von XBRL US für Microsoft bereitgestellte Informationen:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | Eingereichte XBRL-Daten |
| ID | WA200002591 |
...
| Kernfunktionen der App | XBRL US ist das non-profit consortium building and supporting free, open, nonproprietar business reporting standards in the U.S. XBRL US has led the development and implementation of data standards for government agencies - the Securities and Exchange Commission (SEC), the Federal Energy Regulatory Commission (FERC) and the Department of Energy. XBRL US überwacht Daten und hilft bei der Erstellung von Datenqualitätsstandards, die von der SEC verwendet werden, um öffentlichen Unternehmen zu helfen, qualitativ hochwertige XBRL-Finanzberichte zu erstellen.  |
| Firmenstandort | Vereinigte Staaten von Amerika |
| Seite "App-Informationen" | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
...
Diese Informationen wurden von XBRL US dazu bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.

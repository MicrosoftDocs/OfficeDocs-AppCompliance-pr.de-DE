...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für gespeicherte XBRL-Daten, seine Datenverarbeitungsrichtlinien, die Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
---
# <a name="xbrl-filed-data"></a>Gespeicherte XBRL-Daten
...
* <a href="https://appsource.microsoft.com/product/office/WA200002591" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von XBRL US an Microsoft bereitgestellte Informationen:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | Gespeicherte XBRL-Daten |
| ID | WA200002591 |
| unterstützte Office 365 Clients | Excel 2016 oder höher auf mac, Excel 2016 oder höher auf Windows, Excel im Web |
| Name des Partnerunternehmens | XBRL US |
| Website des Unternehmens | [https://xbrl.us](https://xbrl.us) |
| Nutzungsbedingungen der App | [https://xbrl.us/terms-of-agreement](https://xbrl.us/terms-of-agreement) |
| Kernfunktionen der App | XBRL US ist das gemeinnützige Konsortium, das kostenlose, offene, nichtproprietäre Meldestandards für Unternehmen in den USA erstellt und unterstützt. XBRL US hat die Entwicklung und Implementierung von Datenstandards für Regierungsbehörden geleitet - die Securities and Exchange Commission (SEC), die Federal Energy Regulatory Commission (FERC) und das Department of Energy. XBRL US überwacht Daten und hilft bei der Erstellung von Datenqualitätsstandards, die von der SEC verwendet werden, um öffentlichen Unternehmen bei der Erstellung guter XBRL-Abschlüsse zu helfen.  |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
| Was ist die Hostingumgebung oder das Dienstmodell, die zum Ausführen Ihrer App verwendet wird? |  |
| Welche Hosting-Cloudanbieter verwendet die App? | GitHub |
...
Diese Informationen wurden von XBRL US darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.

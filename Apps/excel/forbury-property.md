---
title: Application Information for Forweb by Forarray-Eigenschaft
ms.author: elmalova
author: elenamalova
ms.date: 11/19/2021
ms.topic: article
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Forframe, die Datenverarbeitungsrichtlinien, die Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "61146780"
---
# <a name="forbury"></a>For über sich selbst

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 19, 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002916" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von der Forloc-Eigenschaft für Microsoft bereitgestellt werden:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | For über sich selbst |
| ID | WA200002916 |
| Office 365 unterstützten Clients | Excel 2016 oder höher auf dem Mac, Excel 2016 oder höher auf Windows Excel im Web |
| Name des Partnerunternehmens | Forbury-Eigenschaft |
| Website des Unternehmens | [https://www.forbury.com](https://www.forbury.com) |
| Nutzungsbedingungen der App | [https://www.forbury.com/terms-of-use](https://www.forbury.com/terms-of-use) |
| Kernfunktionen der App | Die schnellste Möglichkeit, kommerzielle Immobilienkäufe (Analysen) in Ihrer Formap-Software zu unterstützen. |
...
Diese Informationen wurden von der Forcloud-Eigenschaft bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Übertragen Sie Kundendaten oder Kundeninhalte an Dritte oder Unterverarbeiter? | Nr. |
...
| URL der Datenschutzrichtlinie | https://www.forbury.com/privacy-policy |
| Führt die App eine automatisierte Entscheidungsfindung durch, einschließlich Profilerstellung, die rechtliche Auswirkungen oder ähnliche Auswirkungen haben könnte? | Nr. |
| Verarbeitet die App Kundendaten für einen sekundären Zweck, der nicht in der Datenschutzerklärung (d. h. Marketing, Analyse) beschrieben ist? | Nr. |
| Verarbeiten Sie besondere Kategorien vertraulicher Daten (z. B. ethnische Herkunft, politische Meinung, religiöse oder religiöse Überzeugungen, genetischen oder biometrischen Daten, Gesundheitsdaten) oder Kategorien von Daten, die gegen Benachrichtigungsgesetze verstoßen? | Nr. |
| Erfasst oder verarbeitet die App Daten von Minderjährigen (d. h. Personen unter 16 Jahren)? | Nr. |
| Verfügt die App über Funktionen zum Löschen der personenbezogenen Daten einer Person auf Anfrage? | Nr. |
| Verfügt die App über Funktionen zum Einschränken oder Einschränken der Verarbeitung personenbezogener Daten einer Person auf Anfrage? | Nr. |
...
| Haben Sie alle anwendbaren bewährten Methoden, die in der Checkliste für die Microsoft Identity Platform Integration beschrieben sind, überprüft und befolgt? | Nr. |
| Verwendet Ihre App die neueste Version von MSAL (Microsoft-Authentifizierungsbibliothek) oder Microsoft Identity Web für die Authentifizierung? | Nr. |
| Welche Authentifizierungsbibliotheken werden von Ihrer App verwendet, wenn sie keine der oben genannten Bibliotheken verwendet? |  |
| Unterstützt Ihre App Richtlinien für bedingten Zugriff? | Nr. |
| Unterstützt Ihre App continuous Access Evaluation (CAE) | Nr. |

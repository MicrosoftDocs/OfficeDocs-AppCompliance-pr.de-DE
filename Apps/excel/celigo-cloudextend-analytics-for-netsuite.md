...
| Kernfunktionen der App | Für NetSuite-Benutzer wird CloudExtend Analytics für NetSuite (CEAN) Ihre Daten visualisieren, um alle Einblicke bereitzustellen, die Sie benötigen, um die richtige Geschäftsentscheidung zur richtigen Zeit zu treffen. CEAN ist ein Tool, das alle erforderlichen Tools bereitstellt, die Flexibilität bieten, Ihre Daten zu kontrollieren und zu kontrollieren, um Einblicke in Ihre NetSuite-Daten zu erhalten. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Beide | Lesen der Sammlung von Websites, für die der Benutzer Zugriff hat, um Informationen zu Arbeitsmappen abzurufen, die über Websites freigegeben wurden | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |

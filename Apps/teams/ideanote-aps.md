---
title: Anwendungsinformationen für Ideanote von Ideanote ApS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Ideanote, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/b18682e5-87f8-413a-9af4-be50bcee1049" target="_blank">Anzeigen im Teams Speicher</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003876" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von Ideanote ApS für Microsoft bereitgestellt werden:
...
| Name des Partnerunternehmens | Ideanote ApS |
| Website des Unternehmens | [https://ideanote.io](https://ideanote.io) |
| Nutzungsbedingungen der App | [https://ideanote.io/legal/terms](https://ideanote.io/legal/terms) |
| Kernfunktionen der App | Sammeln, Entwickeln und Verwalten von Ideen mit zielorientierten Innovationen. |
| Firmenstandort | Dänemark |
| Seite "App-Informationen" | [https://ideanote.io](https://ideanote.io) |
...
Diese Informationen wurden von Ideanote ApS zur Verfügung gestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden in Ihren Datenbanken gespeichert? | Informationen zum JWT-Token, das vom Benutzer abgerufen wurde. Benutzername, Benutzer-E-Mail. |
...
| URL der Datenschutzrichtlinie | https://ideanote.io/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegiert | Wir benötigen Informationen über den Benutzer, um die Person automatisch bei ihrem Ideanote-Konto anzumelden. | [d7db1079-6f45-4373-bb2b-ae5d71169b31](../azure/d7db1079-6f45-4373-bb2b-ae5d71169b31.md) |

---
title: Anwendungsinformationen zum Lesen des Besprechungsnavigators von Read AI, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/15/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für den Besprechungsnavigator lesen, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "65357116"
---
# <a name="read-meeting-navigator"></a>Besprechungsnavigator lesen

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 15. April 2022</p>

* <a href="https://teams.microsoft.com/l/app/18eb20ae-cd59-48c6-8060-fbe171a917e5" target="_blank">Anzeigen im Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003896" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von Read AI, Inc. an Microsoft bereitgestellt werden:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | Besprechungsnavigator lesen |
| ID | WA200003896 |
| unterstützte Office 365 Clients | Microsoft Teams |
| Name des Partnerunternehmens | Read AI, Inc. |
| Website des Unternehmens | [https://read.ai](https://read.ai) |
| Nutzungsbedingungen der App | [https://read.ai/tos](https://read.ai/tos) |
| Kernfunktionen der App | "Dashboard lesen" misst die Besprechungsstimmung, das Engagement und die Gesamtleistung. |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://www.read.ai/product](https://www.read.ai/product) |
...
Diese Informationen wurden von Read AI, Inc. darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Benutzerprofildaten, Besprechungsaudiodaten und Besprechungsvideodaten  |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | Benutzerprofildaten, aus Audio- und Videodaten abgeleitete Benutzermetriken aggregieren |
...
| Welche SOC 2-Zertifizierung haben Sie erreicht? | Typ 1 |
| Neuestes SOC2-Zertifizierungsdatum | 2022-04-14 |
...
| URL der Datenschutzrichtlinie | https://read.ai/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegiert | Wir ermöglichen Es Benutzern, ihre Kalender mit unserem Dienst zu verknüpfen, um die automatische Versendung unseres Azure Media Bot zu ermöglichen. | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| Calls.AccessMedia.All | Anwendung | Zugreifen auf Audio- und Videodaten von Besprechungen für die Anwendungsverarbeitung | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| Calls.JoinGroupCall.All | Anwendung | Wir benötigen Teilnahmeberechtigungen für unseren Azure-Medienbot, um an der laufenden Teams Besprechung teilnehmen zu können. | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| User.Read | Delegiert | Im Rahmen unseres SSO-Prozesses greifen wir auf die benötigten Benutzerdaten zu, indem wir Leseberechtigungen für ihre Benutzerprofile anfordern. | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| email | Delegiert | Im Rahmen des Kontoerstellungsprozesses sind E-Mail-Adressen erforderlich.  | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| openid | Delegiert | Wir ermöglichen Es Benutzern, sich über SSO anzumelden | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| Profil | Delegiert | Wir benötigen Benutzerprofildaten zum Erstellen von Benutzerkonten (insbesondere Vorname und Nachname). | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |

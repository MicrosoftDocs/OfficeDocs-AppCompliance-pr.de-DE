---
title: Anwendungsinformationen für Motionlab von Motionlab
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Motionlab, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "66549492"
---
# <a name="motionlab"></a>Motionlab

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 30. Mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/8ad5fc1b-251b-4d14-aceb-2624bcab0e85" target="_blank">Im Teams Store anzeigen</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004250" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Motionlab an Microsoft bereitgestellte Informationen:
...
| Name des Partnerunternehmens | Motionlab |
| Website des Unternehmens | [https://www.motionlab.io](https://www.motionlab.io) |
| Nutzungsbedingungen der App | [https://www.motionlab.io/term-of-use](https://www.motionlab.io/term-of-use) |
| Kernfunktionen der App | Erstellen Sie ganz einfach personalisierte Videos direkt in Microsoft Teams. |
| Hauptsitz des Unternehmens | Tschechien |
| App-Infoseite | |
...
Diese Informationen wurden von Motionlab darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Informationen, die zum Erstellen eines personalisierten Videos erforderlich sind. |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | Informationen, die zum Erstellen eines personalisierten Videos erforderlich sind. |

---
title: Anwendungsinformationen für Photo Filer von Ichimetadaten
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Photo Filer, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "64463859"
---
# <a name="photo-filer"></a>Fotodateigeber

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: February 25, 2022</p>

* <a href="https://teams.microsoft.com/l/app/28fdbeb3-f306-4d78-a1d8-2c1bef32e6ea" target="_blank">Anzeigen im Teams Speicher</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003881" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von Ichi über Microsoft bereitgestellt werden:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | Fotodateigeber |
| ID | WA200003881 |
| unterstützte Office 365-Clients | Microsoft Teams |
| Name des Partnerunternehmens | Ichi dll |
| Website des Unternehmens | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
| Nutzungsbedingungen der App | [https://photofiler.ichicraft.com/terms/](https://photofiler.ichicraft.com/terms/) |
| Kernfunktionen der App | Die einfachste Möglichkeit, Ihre Fotos in Microsoft Teams freizugeben und zu archivieren. |
| Firmenstandort | Niederlande (die) |
| Seite "App-Informationen" | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
...
Diese Informationen wurden von Ichi über die Erfassung und Speicherung von Organisationsdaten durch diese App und die Kontrolle Ihrer Organisation über die von der App erfassten Daten bereitgestellt.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | Delegiert | Erstellen einer Chatnachricht mit einer kleinen Zusammenfassung der Fotos, die vom Benutzer hochgeladen wurden. | [e54fe734-doppelklick8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| Files.ReadWrite.All | Delegiert | Lesen der Ordnerstruktur und Hochladen von Dateien in der SharePoint Dokumentbibliothek. | [e54fe734-doppelklick8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| User.Read | Delegiert | Lesen aus dem Benutzerprofil. | [e54fe734-doppelklick8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |

...
* <a href="https://teams.microsoft.com/l/app/64f174e8-7e14-4b48-871e-2fb7b17be302" target="_blank">Ansicht im Teams Store</a>
...
Diese Informationen wurden von MailClark darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Mail.ReadWrite | Anwendung |  | Read: So abonnieren Sie Pushbenachrichtigungen für eingehende E-Mails. Write: So erstellen Sie Entwürfe. |  |
>| Mail.Send | Anwendung |  | So senden Sie Entwürfe aus. |  |
>| User.Read | Anwendung | Kontodetails, z. B. E-Mail-Adresse. | So identifizieren Sie das Konto. |  |
>| offline_access | Anwendung | Aktualisierungstoken | So verlängern Sie die Authentifizierung, bis das Konto getrennt ist. |  |
>| openid | Anwendung |  | Erforderlich für die Authentifizierung. |  |
>| Profil | Anwendung |  | So authentifizieren Sie den Benutzer. |  |
...
>Im Rahmen der Einhaltung der DSGVO können Administratoren Löschungen, Datenzugriff und vieles mehr anfordern (Weitere Informationen finden Sie auf der Registerkarte Recht).
...
<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35675" target="_blank">Anzeigen auf einer neuen Registerkarte</a>

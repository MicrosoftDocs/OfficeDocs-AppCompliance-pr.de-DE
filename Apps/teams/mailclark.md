...
| Website des Unternehmens | [https://mailclark.ai/microsoft-teams-integration](https://mailclark.ai/microsoft-teams-integration) |
| Nutzungsbedingungen der App | [https://mailclark.ai/tos](https://mailclark.ai/tos) |
| Kernfunktionen der App | Verwalten von &amp; Antworten auf E-Mails, Facebook- und Twitter-Nachrichten in Microsoft Teams. |
| Firmenstandort |  |
...
| Entspricht die App health Information Trust Alliance, Common Security Framework (HITRUST CSF)? |  |
...
| Entspricht die App der International Organization for Standardization (ISO 27017)? |  |
...
| Entspricht die App dem FERPA (Family Educational Rights and Privacy Act)? |  |
| Entspricht die App dem Children's Online Privacy Protection Act (COPPA)? |  |
...
| **Information** | **Antwort** |
|:----------------|:-------------|
| Ist Ihre Anwendung in die Microsoft Identity Platform (Azure AD) für einmaliges Anmelden, API-Zugriff usw. integriert? |  |

...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| User.Read | Delegiert | Benutzer-&#8217;Azure Active Directory-ID. | Benutzeridentifikation, um sicherzustellen, dass Benutzer nur die für sie sichtbaren Daten sehen und verwalten können. | [](https://docs.microsoft.com/microsoft-365-app-certification/azure/) |
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| **Name** – wird verwendet, um den Namen des Antragstellers anzuzeigen. **E-Mail** – wird verwendet, um Benutzer in Teams und Chats zu identifizieren; wird als eindeutiger Bezeichner des Wählers verwendet; wird verwendet, um feedbacks von Benutzern innerhalb Teams zu beantworten. Es werden keine unerwünschten E-Mails an Benutzer gesendet. | Vor- und Nachnamen, Anzeigename, E-Mail-Adresse |  |

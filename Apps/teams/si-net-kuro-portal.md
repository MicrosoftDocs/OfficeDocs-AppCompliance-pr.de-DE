---
title: Anwendungsinformationen für das KURO-Portal von Si-Net
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/23/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für das KURO-Portal, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "65692374"
---
# <a name="kuro-portal"></a>KURO-Portal

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 3. Mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/c4af7af6-4fa4-4777-bab7-713cda6d0f74" target="_blank">Anzeigen im Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004019" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Si-Net an Microsoft bereitgestellte Informationen:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | KURO-Portal |
| ID | WA200004019 |
| unterstützte Office 365 Clients | Microsoft Teams |
| Name des Partnerunternehmens | Si-Net |
| Website des Unternehmens | [https://www.si-net.it](https://www.si-net.it) |
| Nutzungsbedingungen der App | [https://www.si-net.it/termini-di-utilizzo-kuro/](https://www.si-net.it/termini-di-utilizzo-kuro/) |
| Kernfunktionen der App | Die KURO PORTAL-App für Teams verspricht, ein leichtes CRM zu sein, bei dem Die Benutzer auf einen Blick alle notwendigen Kundeninformationen haben können, als Telefonbuch verwendet werden können, um direkt von Teams mit ihrem eigenen Telefonbetreiber anzurufen, E-Mails direkt an die Kontakte zu senden, direkt zu chatten und eine Besprechung mit Kuro Portal-Gastkunden zu erstellen,  Einfaches und schnelles Durchsuchen von Kundeninformationen, direkter Zugriff auf die ausgewählte Kunden-&#8217;Dokumentsammlung und gemeinsame Dokumentverwaltung  |
...
Diese Informationen wurden von Si-Net darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Kundenmandant und Gerät |
...
| URL der Datenschutzrichtlinie | https://www.si-net.it/termini-di-utilizzo-kuro/ |

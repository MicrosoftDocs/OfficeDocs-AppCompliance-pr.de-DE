---
title: Anwendungsinformationen für Teameo Class Space von LS2 Innovation
ms.author: elmalova
author: elenamalova
ms.date: 01/03/2022
ms.topic: article
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Teameo Class Space, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/ec7d1cd2-2a06-4f96-baa5-1cc88026a835" target="_blank">Anzeigen im Teams Speicher</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003630" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von LS2 Innovation für Microsoft bereitgestellte Informationen:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | Teameo Class Space |
| ID | WA200003630 |
| Office 365 unterstützten Clients | Microsoft Teams |
| Name des Partnerunternehmens | LS2 Innovation |
| Website des Unternehmens | [https://teameo.io](https://teameo.io) |
| Nutzungsbedingungen der App | [https://teameo.io/legal/terms-of-service.html](https://teameo.io/legal/terms-of-service.html) |
| Kernfunktionen der App | Teameo Class Space ermöglicht Lehrern das Anzeigen der Kursdetails, Anwendungen und Links. |
...
Diese Informationen wurden von LS2 Innovation dazu bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden in Ihren Datenbanken gespeichert? | Benutzerinformationen (Name, E-Mail), Mandanteninformationen (ID, Name) |
...
| URL der Datenschutzrichtlinie | https://teameo.io/legal/privacy-policy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.ReadWrite.All | Anwendung | Gestion de Teams App pour Espace Num&#233;rique | [05525b77-8ca6-462f-8902-15788cb405c6](https://docs.microsoft.com/microsoft-365-app-certification/azure/05525b77-8ca6-462f-8902-15788cb405c6) |

...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Stack Overflow für Teams, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "66656156"
---
# <a name="stack-overflow-for-teams"></a>Stack Overflow for Teams

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 11. Oktober 2021</p>

* <a href="https://teams.microsoft.com/l/app/4783e622-5303-4ea7-a211-ef0dd405da73" target="_blank">Im Teams Store anzeigen</a>
...
Von Stack Overflow an Microsoft bereitgestellte Informationen:
...
| Website des Unternehmens | [https://www.stackoverflow.com](https://www.stackoverflow.com) |
| Nutzungsbedingungen der App | [https://stackoverflow.com/legal/terms-of-service/teams](https://stackoverflow.com/legal/terms-of-service/teams) |
| Kernfunktionen der App | Stack Overflow für Teams ist ein privates, sicheres Zuhause für Ihr Team&#8217;Fragen und Antworten. Sie können nicht mehr veraltete Wikis und verlorene E-Mails durchgehen,&#8212;Ihrem Team die Zeit zurückzugeben, die es benötigt, um bessere Produkte zu erstellen. Stack Overflow für Teams&#8217; Integration in Microsoft Teams verbindet Ihren Microsoft Teams-Chat und Ihr internes Wissensrepository. Bleiben Sie mit Benachrichtigungen zu neuen Informationen auf dem laufenden, suchen Sie nach vorhandenen Antworten, und beginnen Sie Ihre Frage sogar direkt über die Microsoft Teams-Plattform. |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://stackoverflow.co/teams/integrations/microsoft-teams](https://stackoverflow.co/teams/integrations/microsoft-teams) |
...
Diese Informationen wurden von Stack Overflow darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | MS Teams-Informationen werden von der App gesammelt und verarbeitet, um angezeigt zu werden, sowie Verweise in der Stack Overflow for Teams-Umgebung eines Kunden. |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | MS Teams-API-Zugriffsinformationen |
...
| URL der Datenschutzrichtlinie | https://stackoverflow.com/legal/privacy-policy/integrations/ms-teams/teams-basic-business |

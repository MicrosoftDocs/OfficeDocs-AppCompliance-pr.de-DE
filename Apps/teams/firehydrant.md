---
title: Anwendungsinformationen für FireHydrant von FireHydrant
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für FireHydrant, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "64878672"
---
# <a name="firehydrant"></a>FireHydrant

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 10. Februar 2022</p>

* <a href="https://teams.microsoft.com/l/app/c18f3920-4098-4907-bc92-43c8559b5e18" target="_blank">Anzeigen im Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003794" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von FireHydrant an Microsoft bereitgestellt werden:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | FireHydrant |
| ID | WA200003794 |
| unterstützte Office 365 Clients | Microsoft Teams |
| Name des Partnerunternehmens | FireHydrant |
| Website des Unternehmens | [https://firehydrant.io](https://firehydrant.io) |
| Nutzungsbedingungen der App | [https://app.firehydrant.io/legal/ssa](https://app.firehydrant.io/legal/ssa) |
| Kernfunktionen der App | Verwalten Sie Ihre Vorfälle mit FireHydrant.io. |
...
Diese Informationen wurden von FireHydrant darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Benutzeridentität (Name, E-Mail), Vorfalldaten aus Teams-Kanälen |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | Team-ID, Mandanten-ID, Nachrichten, Benutzername |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | Delegiert | FireHydrant erstellt Kanäle im Namen unserer Benutzer, um Vorfälle zu verwalten | [00485db5-81b3-4299-833a-8d6c366d0ac0](../azure/00485db5-81b3-4299-833a-8d6c366d0ac0.md) |

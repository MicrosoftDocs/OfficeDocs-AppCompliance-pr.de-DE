---
title: Anwendungsinformationen für Pandos von Pandos Intelligence Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/05/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Pandos, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/0e777926-2ab4-4e40-9fe5-80dc68e5044f" target="_blank">Anzeigen im Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003534" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Pandos Intelligence Inc. an Microsoft bereitgestellte Informationen:
...
| Name des Partnerunternehmens | Pandos Intelligence Inc |
| Website des Unternehmens | [https://pandos.io](https://pandos.io) |
| Nutzungsbedingungen der App | [https://app.pandos.io/terms-of-use](https://app.pandos.io/terms-of-use) |
| Kernfunktionen der App | Pandos ist eine zentrale Lern- und Entwicklungsplattform für Team- und Personalmanager, Projektleiter, Trainer und Bildungslehrer. Es unterstützt grundlegende Features wie Teambildung basierend auf Kriterien (einschließlich Verfügbarkeit, Persönlichkeit, Fähigkeiten oder einem beliebigen benutzerdefinierten Kriterium), Teamaufgabenverwaltung und Peer-Bewertung. Die Plattform generiert automatisch ein Profil für die Soft Skills der Mitglieder, die von Peers überprüft werden.  |
| Hauptsitz des Unternehmens | Kanada |
| App-Infoseite | [https://pandos.io](https://pandos.io) |
...
Diese Informationen wurden von Pandos Intelligence Inc. darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.

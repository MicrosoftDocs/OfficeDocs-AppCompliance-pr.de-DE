---
title: Bewerbungsinformationen für das CyCX Contact Center von CyTrack
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für das CyCX Contact Center, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "66656164"
---
# <a name="cycx--contact-centre"></a>CyCX Contact Center

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 27. Mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/4d7b80a9-d64d-4b54-a1db-259cc204b15d" target="_blank">Im Teams Store anzeigen</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004350" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von CyTrack an Microsoft bereitgestellte Informationen:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | CyCX Contact Center |
| ID | WA200004350 |
| unterstützte Office 365 Clients | Microsoft Teams |
| Name des Partnerunternehmens | CyTrack |
| Website des Unternehmens | [https://web.cytrack.com](https://web.cytrack.com) |
| Nutzungsbedingungen der App | [https://web.cytrack.com/subscription-service-software-agree...](https://web.cytrack.com/subscription-service-software-agreement/) |
| Kernfunktionen der App | CyCX richtet sich an Geschäftsbenutzer, die die Kundenerfahrung mit Sprachanrufen und Kontaktcenterfunktionen über Besprechungen, Chats und Zusammenarbeit hinaus steigern möchten.  CyCX ist eine Plattform für Kommunikation und Zusammenarbeit für Microsoft Teams.  Treffen Sie Ihre Kunden auf dem Kanal ihrer Wahl in Microsoft Teams, bietet CyTrack CyCX Ihren Agenten eine einzige, einheitliche Schnittstelle mit einer ganzheitlichen Ansicht der Kunden, um tiefere Interaktionen zu ermöglichen. |
| Hauptsitz des Unternehmens | Australien |
| App-Infoseite | [https://web.cytrack.com/microsoft-teams/contact-centre-for-...](https://web.cytrack.com/microsoft-teams/contact-centre-for-microsoft-teams/) |
...
Diese Informationen wurden von CyTrack darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Teams-Anrufdaten |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | Teams-Anrufdaten |
| Wenn zugrunde liegende Infrastrukturprozesse oder Microsoft-Kundendaten gespeichert werden, wo werden diese Daten geografisch gespeichert? | Australien, Neuseeland, Vereinigtes Königreich Großbritannien und Nordirland (die) |
...
| URL der Datenschutzrichtlinie | https://web.cytrack.com/privacy-policy-teams/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppRoleAssignment.ReadWrite.All | Delegiert | Dies ist erforderlich, um servicePrincipal zu erstellen, um API-Berechtigungen in der Azure AD-App im Kundenmandanten zu gewähren. | [acafd8f7-a6d3-420e-89d7-7729751b7c04](../azure/acafd8f7-a6d3-420e-89d7-7729751b7c04.md) |
>| Application.ReadWrite.All | Delegiert | Wir benötigen diese Berechtigung zum Erstellen einer Azure AD-App im Kundenmandanten, die wir zum Abonnieren von Änderungsbenachrichtigungsdiensten zum Abrufen von Metadaten im Zusammenhang mit Teams-Anrufen verwenden. | [acafd8f7-a6d3-420e-89d7-7729751b7c04](../azure/acafd8f7-a6d3-420e-89d7-7729751b7c04.md) |

---
title: Anwendungsinformationen für Edgility durch Edgility
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/14/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Edgility, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/fe2f94eb-7164-4fcd-a2c7-16db90307caa" target="_blank">Anzeigen im Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003970" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Edgility an Microsoft bereitgestellte Informationen:
...
| Name des Partnerunternehmens | Edgility |
| Website des Unternehmens | [https://edgility.com.au](https://edgility.com.au) |
| Nutzungsbedingungen der App | [https://www.edgility.com.au/legal/](https://www.edgility.com.au/legal/) |
| Kernfunktionen der App | Edgility ist führend bei der Entwicklung integrierter Unternehmenskommunikationstools. Diese SMS-Lösungen ermöglichen es Organisationen, den Prozess der Erinnerung, Förderung, Warnung und Benachrichtigung der Personen, die für ihr Unternehmen wichtig sind, mithilfe der Plattformen zu optimieren, auf denen sie bereits angewiesen sind. Dazu gehören Microsoft-Produkte wie Excel, Outlook und Teams. Benutzer können dieses effektive Unterhaltungstool nutzen, indem sie SMS an Microsoft Outlook und Teams erhalten. |
| Hauptsitz des Unternehmens | Australien |
| App-Infoseite | [https://www.edgility.com.au/microsoft/teams/](https://www.edgility.com.au/microsoft/teams/) |
...
Diese Informationen wurden von Edgility darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Namen |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Nr. |
...
| Verfügen Sie über eine Richtlinie, die Ihre Service Level Agreement (SLA) für die Anwendung von Patches regelt? | Nr. |
...
| **Information** | **Response** |
|:----------------|:-------------|
| Ist Ihre Anwendung in Microsoft Identity Platform (Azure AD) für einmaliges Anmelden, API-Zugriff usw. integriert? | Nr. |

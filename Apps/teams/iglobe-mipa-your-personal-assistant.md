...
<p>Zuletzt aktualisiert vom Entwickler am: 6. November 2020</p>

* <a href="https://teams.microsoft.com/l/app/eec9d2db-2325-43f5-83c7-eac7c5253a87" target="_blank">Ansicht in Teams Store</a>
...
| URL der Partner-Website | [https://mipa.iglobe.dk/](https://mipa.iglobe.dk/) |
...
>| Directory.AccessAsUser.All | Delegiert | Es werden keine Daten in Anwendungsdatenbanken gespeichert. | Lesen, Aktualisieren, Erstellen von Panner-Aufgaben, Lesen der benutzerneuesten und freigegebenen Dateien. Um zu überprüfen, dass der Benutzer die Zustimmung hat und Zugriff auf die Verwendung der API hat. | e854ea05-68ab-4204-babe-db4a784fb4d16 |
>| Directory.ReadWrite.All | Delegiert | Es werden keine Daten in Anwendungsdatenbanken gespeichert. | Lesen, Aktualisieren, Erstellen von Panner-Aufgaben, Lesen der Benutzer aktuelle und freigegebene Dateien, um SharePoint Liste, Bibliotheken und Dateien zu erhalten. So speichern Sie Dateien in SharePoint Listen. | e854ea05-68ab-4204-babe-db4a784fb4d16 |
...
>| openid | Delegiert | Es werden keine Daten in Anwendungsdatenbanken gespeichert. | Ermöglicht Benutzern die Anmeldung bei der App mit ihren Arbeits- oder Schulkonten und ermöglicht es der App, grundlegende Benutzerprofilinformationen (für SSO) anzuzeigen. | e854ea05-68ab-4204-babe-db4a784fb4d16 |

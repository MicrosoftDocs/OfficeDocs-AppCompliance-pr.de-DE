---
title: Anwendungsinformationen für einheitliche Kontakte von glueckkanja-gab AG
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für einheitliche Kontakte, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/085251c0-aef3-11ea-bccf-6fc12269b243" target="_blank">Anzeigen im Teams Speicher</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003877" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von glueckkanja-gab AG an Microsoft bereitgestellt werden:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | Einheitliche Kontakte |
| ID | WA200003877 |
| unterstützte Office 365-Clients | Microsoft Teams |
| Name des Partnerunternehmens | glueckkanja-gab AG |
| Website des Unternehmens | [https://www.glueckkanja-gab.com/en](https://www.glueckkanja-gab.com/en) |
| Nutzungsbedingungen der App | [https://www.glueckkanja-gab.com/en/products/unified-contact...](https://www.glueckkanja-gab.com/en/products/unified-contacts/terms-and-conditions) |
| Kernfunktionen der App | Einheitliche Suche nach Azure AD, Ihren Unternehmenskontakten, Exchange Online und Ihren persönlichen Kontakten. |
| Firmenstandort | Deutschland |
| Seite "App-Informationen" | [https://www.glueckkanja-gab.com/en/products/unified-contacts](https://www.glueckkanja-gab.com/en/products/unified-contacts) |
...
Diese Informationen wurden von glueckkanja-gab AG darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| URL der Datenschutzrichtlinie | https://www.glueckkanja-gab.com/en/products/unified-contacts/privacy |
...
| Wird die Zustimmung von einem Übergeordneten oder gesetzlichen Vertreter eingeholt? | Nein |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts.Read.Shared | Delegiert | Einheitliche Kontakte erfordern Zugriff auf Kontaktdaten im Kundenmandanten, um grundlegende Funktionen bereitzustellen. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
>| Directory.Read.All | Delegiert | Einheitliche Kontakte erfordern Zugriff auf Kontaktdaten im Kundenmandanten, um grundlegende Funktionen bereitzustellen. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
>| User.Read | Delegiert | Einheitliche Kontakte erfordern Zugriff auf Kontaktdaten im Kundenmandanten, um grundlegende Funktionen bereitzustellen. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |

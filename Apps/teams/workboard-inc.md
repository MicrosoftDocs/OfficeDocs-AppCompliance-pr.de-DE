...
Informationen, die von Workboard Inc. an Microsoft bereitgestellt werden:
...
| Kernfunktionen der App | Richten Sie strategische Prioritäten über die Organisation aus, und lokalisieren Sie Ziele und wichtige Ergebnisse (OKRs) auf funktionsübergreifende Teams und Einzelpersonen. Diagramm, Berechnen und Teilen des Fortschritts zu wichtigen Ergebnissen und Erfolgsmetriken.  |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://www.workboard.com/microsoft/](https://www.workboard.com/microsoft/) |
...
Diese Informationen wurden von Workboard Inc. darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegiert | E-Mail-Adresse und die Benutzer-IDs.  Es wird verwendet, um den Benutzer der Benutzer-ID von WorkBoard zuzuordnen. | [](../azure/.md) |

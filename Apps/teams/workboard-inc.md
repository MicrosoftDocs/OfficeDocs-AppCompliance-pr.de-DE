---
title: Anwendungsinformationen für Workboard von Workboard Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2021
...
* <a href="https://teams.microsoft.com/l/app/28d0282b-3cd2-49f0-90bb-a016843750c6" target="_blank">Anzeigen im Teams Speicher</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381599" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Workboard Inc. für Microsoft bereitgestellte Informationen:
...
| Name des Partnerunternehmens | Workboard, Inc. |
| Website des Unternehmens | [https://www.workboard.com](https://www.workboard.com) |
| Nutzungsbedingungen der App | [https://www.workboard.com/license/terms_of_use_v1.php](https://www.workboard.com/license/terms_of_use_v1.php) |
| Kernfunktionen der App | Richten Sie strategische Prioritäten über die Organisation aus, und lokalisieren Sie Ziele und wichtige Ergebnisse (OKRs) an funktionsübergreifende Teams und Einzelpersonen. Diagramm, Berechnen und Teilen des Fortschritts für wichtige Ergebnisse und Erfolgsmetriken.  |
| Firmenstandort | Vereinigte Staaten von Amerika |
| Seite "App-Informationen" | [https://www.workboard.com/microsoft/](https://www.workboard.com/microsoft/) |
...
Diese Informationen wurden von Workboard Inc. zur Verfügung gestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Auflisten der unterstützten Richtlinientypen | WorkBoard hat eigene Zugriffsrichtlinien implementiert, die innerhalb der App erzwungen werden.  Die Organisation, das Team und die Identität des Benutzers werden verwendet, um die Zugriffsrechte zu bestimmen. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegiert | E-Mail-Adresse und die Benutzer-IDs.  Es wird verwendet, um den Benutzer der WorkBoard-Benutzer-ID zuzuordnen. | [User.Read](../azure/User.Read.md) |

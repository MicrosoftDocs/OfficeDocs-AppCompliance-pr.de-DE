...
Von Hi5Technologies für Microsoft bereitgestellte Informationen:
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| So benachrichtigen Sie den Benutzer in einem Kanal, dass ihm ein Hi5 zugewiesen wurde | Es werden keine Informationen gespeichert, der Benutzer wird nur @ von der Im Kanal zurücksandten Karte sein. | Es werden keine Informationen gespeichert, der Benutzer wird nur @ von der Im Kanal zurücksandten Karte sein. |
...
>Wir verwenden OAuth und stellen drei Anmeldeoptionen bereit:
- Googles SSO (OAuth).
- Microsoft SSO (OAuth).
...
<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36143" target="_blank">Ansicht auf einer neuen Registerkarte</a>
...
Diese Informationen wurden von Hi5Technologies bereitgestellt, wie diese App Authentifizierung, Autorisierung, bewährte Methoden für die Anwendungsregistrierung und andere Identitätskriterien behandelt.

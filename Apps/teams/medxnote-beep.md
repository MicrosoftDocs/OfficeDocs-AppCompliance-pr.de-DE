---
title: Anwendungsinformationen für Signalton von Medxnote
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Beep, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
<p>Letzte Aktualisierung durch den Entwickler am: 11. Mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/6b8b29d8-5beb-4eae-915e-5a56a0e1f5a6" target="_blank">Im Teams Store anzeigen</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004364" target="_blank">Anzeigen in AppSource</a>
...
| Website des Unternehmens | [https://medxnote.com](https://medxnote.com) |
| Nutzungsbedingungen der App | [https://medxnote.com/terms-conditions/](https://medxnote.com/terms-conditions/) |
| Kernfunktionen der App | Verbessern Sie die klinische Zusammenarbeit mit der EPR-Aufgabenintegration von MedxPlanner in Microsoft Teams. |
...
| Welche Daten werden von Ihrer App verarbeitet? | Mandanten-ID, Benutzerprofil, Tags |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | Mandanten-ID, Benutzerprofil, Tags |
...
| URL der Datenschutzrichtlinie | https://medxnote.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.ReadWrite.All | beides | Wir erhalten die Organisationsinformationen des Benutzers. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| TeamsActivity.Send | Anwendung | Diese Berechtigung wird verwendet, um Aktivitäten an den Benutzer zu senden. Daher verwenden wir diese, um eine programmgesteuerte Aktivität im Feed des Benutzers zu erstellen, um sie darauf aufmerksam zu machen, dass die Aufgabe aktualisiert wird. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| TeamworkTag.ReadWrite | Anwendung | Wir verwenden diese Berechtigung, um die Tags innerhalb der Teams in Microsoft Teams abzurufen und zu erstellen. Damit wir sie programmgesteuert erwähnen können. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.Read | Delegiert | Mit dieser Berechtigung erhalten wir grundlegende Informationen der Benutzer wie displayName, mail, userPrincipalName, ID und Foto. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.Read.All | Anwendung | Damit rufen wir die Gesamteigenschaften ab. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.ReadWrite.All | Anwendung | Auf diese Weise erhalten wir die beigetretenen Teams der Benutzer. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |

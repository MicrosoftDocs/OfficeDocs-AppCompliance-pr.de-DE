---
title: Anwendungsinformationen für Loop nach Anzeigeflüssen
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/18/2021
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Loop, seine Datenverarbeitungsrichtlinien, die Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "64879752"
---
# <a name="loop"></a>Loop

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 10. November 2021</p>

* <a href="https://teams.microsoft.com/l/app/5dcf4bd7-eccd-4f6d-b5f0-a4e04aab4ff9" target="_blank">Anzeigen im Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003480" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von Friendly Flows an Microsoft bereitgestellt werden:
...
| Name des Partnerunternehmens | Benutzerfreundliche Flows |
| Website des Unternehmens | [https://friendlyflows.com](https://friendlyflows.com) |
| Nutzungsbedingungen der App | [https://friendlyflows.com/terms-of-use/](https://friendlyflows.com/terms-of-use/) |
| Kernfunktionen der App | Menschen zur richtigen Zeit zusammenbringen, um an Projekten zu arbeiten. |
| Hauptsitz des Unternehmens | Niederlande (die) |
| App-Infoseite | [https://friendlyflows.com/loop/](https://friendlyflows.com/loop/) |
...
Diese Informationen wurden von Friendly Flows darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Benutzerprofil, Benutzereingabe |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | Benutzerprofil, Benutzereingabe |
...
| URL der Datenschutzrichtlinie | https://friendlyflows.com/privacy-policy/ |
...
| Welche Authentifizierungsbibliotheken werden verwendet, wenn Ihre App keine der oben genannten Bibliotheken verwendet? | Keine |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegiert | Authentifizierung | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |
>| email | Delegiert | Registrierung | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |
>| Profil | Delegiert | Authentifizierung | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |

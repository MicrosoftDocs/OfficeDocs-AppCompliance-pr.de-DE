---
title: Anwendungsinformationen für kolloquiale lösungen
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/25/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Colloquial, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "67016908"
---
# <a name="colloquial"></a>Umgangssprachliche

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 30. Juni 2022</p>

* <a href="https://teams.microsoft.com/l/app/79b08482-6a09-41ff-a303-7ad2fd9c3531" target="_blank">Im Teams Store anzeigen</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004395" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von Colloquial Solutions an Microsoft bereitgestellt werden:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | Umgangssprachliche |
| ID | WA200004395 |
| unterstützte Office 365 Clients | Microsoft Teams |
| Name des Partnerunternehmens | Kolloquiale Lösungen |
| Website des Unternehmens | [https://www.colloquial.io](https://www.colloquial.io) |
| Nutzungsbedingungen der App | [https://app.colloquial.io/terms](https://app.colloquial.io/terms) |
| Kernfunktionen der App | Eine unkomplizierte Anwendung zum Sammeln und Teilen von Funktions-, Prozess-, App- und Technologiewissen in Ihrer Organisation. Allgemein bekannt als Portfolio oder Katalog. Diese App hilft Ihnen, Ihre Portfolios zu sammeln und zu verwalten. |
| Hauptsitz des Unternehmens | Australien |
| App-Infoseite | [https://www.colloquial.io/solutions](https://www.colloquial.io/solutions) |
...
Diese Informationen wurden von Colloquial Solutions darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Benutzerprofildaten – Vor- und Nachname sowie E-Mail |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | Benutzerprofildaten – Vor- und Nachname sowie E-Mail |
...
| Welche Authentifizierungsbibliotheken werden verwendet, wenn Ihre App keine der oben genannten Bibliotheken verwendet? | Wir verwenden den OAuth2-Autorisierungscodefluss mit der folgenden Bibliothek: https://github.com/RIPAGlobal/omniauth-azure-activedirectory-v2 |

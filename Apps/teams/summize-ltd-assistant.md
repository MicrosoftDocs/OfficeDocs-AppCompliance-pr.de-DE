...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für den Summize-Assistenten, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
---
# <a name="summize-assistant"></a>Add-In-Assistent

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 17, 2021</p>

* <a href="https://teams.microsoft.com/l/app/24d7e745-c1ed-4f60-a843-ba1629ef3ed4" target="_blank">Anzeigen im Teams Speicher</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003577" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Summize (Ltd) an Microsoft bereitgestellte Informationen:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | Add-In-Assistent |
| ID | WA200003577 |
...
| Kernfunktionen der App | Summieren erleichtert die Überprüfung und Erstellung von Verträgen. Summieren ändert sich, wie Unternehmen Verträge verstehen und mit ihnen interagieren. Mithilfe unserer intelligenten Unterhaltungssoftware überlagern wir Ihre Vertragsprozesse und entsperren vertragliche Einblicke.  Die Add-In-Assistent-App in Teams hilft Benutzern, Verträge (PDF- und Docx-Formate) zur Überprüfung hochzuladen.  Benutzer können auch Verträge mithilfe von Vorlagen erstellen, die in der Summize-App erstellt wurden.   |
...
Diese Informationen wurden von Summize (Ltd) darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden in Ihren Datenbanken gespeichert? | Originaldokumente und Kundenrezensionen von Dokumenten |
...
| URL der Datenschutzrichtlinie | https://app.summize.com/assets/documents/SummizePrivacyPolicy.pdf |

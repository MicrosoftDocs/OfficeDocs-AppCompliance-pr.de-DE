---
title: Anwendungsinformationen für Das Startgrid von Startgrid
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/09/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Startgrid, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "63546333"
---
# <a name="startgrid"></a>Startgrid

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Zuletzt aktualisiert vom Entwickler am: 31. Januar 2022</p>

* <a href="https://teams.microsoft.com/l/app/6624420b-7199-41d2-98ff-90d745e039a7" target="_blank">Anzeigen im Teams Speicher</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003838" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Startgrid für Microsoft bereitgestellte Informationen:
...
| Name des Partnerunternehmens | Startgrid |
| Website des Unternehmens | [https://app.startgrid.com](https://app.startgrid.com) |
| Nutzungsbedingungen der App | [https://corp.startgrid.com/terms-of-use](https://corp.startgrid.com/terms-of-use) |
| Kernfunktionen der App | Suchen, teilen und bewerten Sie Technologielösungen, um Herausforderungen schneller zu lösen. |
| Firmenstandort | Vereinigte Staaten von Amerika |
| Seite "App-Informationen" | [https://corp.startgrid.com/platform](https://corp.startgrid.com/platform) |
...
Diese Informationen wurden von Startgrid bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| URL der Datenschutzrichtlinie | https://corp.startgrid.com/privacy-policy |

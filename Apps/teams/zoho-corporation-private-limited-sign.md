...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Zoho Sign, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "65225079"
---
# <a name="zoho-sign"></a>Zoho Sign

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 20. Oktober 2021</p>

* [Anzeigen im Teams Store](https://teams.microsoft.com/l/app/7a22873b-81e6-48ed-aee3-6f0e7dd5a104)
* [Anzeigen in AppSource](https://appsource.microsoft.com/product/office/WA104382011)
...
| Kernfunktionen der App | Zoho Sign ist eine sichere, cloudbasierte App für digitale Signaturen, mit der Sie Ihre Geschäftspapiere legal und elektronisch signieren, senden und verwalten können. Sie können E-Sign-Workflows mühelos erstellen, um Signaturen zu sammeln, Signierer zu authentifizieren, Erinnerungen auszulösen und den Signatur- und Genehmigungsstatus in Echtzeit nachzuverfolgen. Mit Zoho Sign können Sie alle Ihre Papiere auch direkt über Microsoft-Apps über Ihren Webbrowser und unterwegs mit mobilen Apps verwalten. |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://www.zoho.com/sign/help/teams-extension.html](https://www.zoho.com/sign/help/teams-extension.html) |
...
| Wenn zugrunde liegende Infrastrukturprozesse oder Microsoft-Kundendaten gespeichert werden, wo werden diese Daten geografisch gespeichert? | Indien, Japan, Australien, China, Niederlande (die), Irland, USA Amerikas |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegiert | Anmelden und Benutzerprofil lesen | [a67ee0a9-b008-4e90-986d-1eb8d55a81d6](../azure/a67ee0a9-b008-4e90-986d-1eb8d55a81d6.md) |

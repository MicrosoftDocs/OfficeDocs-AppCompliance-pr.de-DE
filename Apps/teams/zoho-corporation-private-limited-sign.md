...
* <a href="https://teams.microsoft.com/l/app/7a22873b-81e6-48ed-aee3-6f0e7dd5a104" target="_blank">Ansicht im Teams Store</a>
...
| URL Teams Anwendungsinfoseite | [https://www.zoho.com/sign/help/teams-extension.html](https://www.zoho.com/sign/help/teams-extension.html) |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Contacts.ReadWrite | delegierte |  | Vollzugriff auf Benutzerkontakte. |  |
>| Contacts.ReadWrite.Shared | delegierte |  | Lese- und Schreibzugriff auf Benutzer- und freigegebene Kontakte. |  |
>| Files.ReadWrite | delegierte |  | Vollzugriff auf Benutzerdateien. |  |
>| Files.ReadWrite.All | delegierte |  | Haben Sie Vollzugriff auf alle Dateien, auf die benutzer zugreifen können. |  |
>| Files.ReadWrite.Selected | delegierte |  | Lese- und Schreibzugriff auf Dateien, die der Benutzer auswählt. |  |
>| User.ReadBasic.All | delegierte |  | Lesen Sie die grundlegenden Profile aller Benutzer. |  |
>| email | delegierte |  | Zeigen Sie die E-Mail-Adresse des Benutzers an. |  |
>| offline_access | delegierte |  | Behalten Sie den Zugriff auf Daten bei, auf die Sie zugriffen haben. |  |
>| Profil | delegierte |  | Zeigen Sie das grundlegende Profil des Benutzers an. |  |
...
>Kunden als Datenverantwortlicher haben immer Zugriff auf die Daten. Administratoren können Benutzer aus "Zoho Sign" hinzufügen oder entfernen. Sie können alle in der Anwendung gespeicherten Informationen anzeigen, einschließlich vollständiger Überwachungspfade und Nutzungsberichte. Sie können Daten und Benutzer löschen und die Steuerung von Daten zwischen Benutzern übertragen.
...
<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35679" target="_blank">Anzeigen auf einer neuen Registerkarte</a>

...
| Kernfunktionen der App | Zoho Sign ist eine sichere, cloudbasierte App für digitale Signaturen, mit der Sie Ihre Geschäftlichen Zettel legal und elektronisch signieren, senden und verwalten können. Sie können E-Sign-Workflows mühelos erstellen, um Signaturen zu sammeln, Signierer zu authentifizieren, Erinnerungen auszulösen und den Signatur- und Genehmigungsstatus in Echtzeit nachzuverfolgen. Mit Zoho Sign können Sie auch alle Ihre Papiere direkt aus Microsoft-Apps über Ihren Webbrowser und unterwegs mit mobilen Apps verwalten. |
| Firmenstandort | Vereinigte Staaten von Amerika |
| Seite "App-Informationen" | [https://www.zoho.com/sign/help/teams-extension.html](https://www.zoho.com/sign/help/teams-extension.html) |
...
| Wo werden diese Daten geografisch gespeichert, wenn zugrunde liegende Unstruktur Microsoft-Kundendaten verarbeitet oder speichert? | Indien, Japan, Australien, China, Niederlande (the), Irland, Vereinigte Staaten von Amerika |

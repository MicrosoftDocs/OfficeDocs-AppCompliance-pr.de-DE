...
| Kernfunktionen der App | Die App bietet ein Einmaliges Anmelden (Single Sign On, SSO) mit einem LTI-Server (Learning Tools Interoperability) zum Starten von Kursen. Es ist ein LTI-Tool Consumer und unterstützt Basic LTI (BLTI). |

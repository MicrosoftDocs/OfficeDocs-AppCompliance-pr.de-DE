---
title: Anwendungsinformationen für Trivia Engine von EnableUC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/09/2021
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Trivia Engine, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "64878702"
---
# <a name="trivia-engine"></a>Trivia Engine

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 1. Oktober 2021</p>

* <a href="https://teams.microsoft.com/l/app/3bd813fa-a19a-4c06-b130-450b24b8ee08" target="_blank">Anzeigen im Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003412" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von EnableUC an Microsoft bereitgestellte Informationen:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | Trivia Engine |
| ID | WA200003412 |
| unterstützte Office 365 Clients | Microsoft Teams |
| Name des Partnerunternehmens | EnableUC |
| Website des Unternehmens | [https://www.triviaengine.com](https://www.triviaengine.com) |
| Nutzungsbedingungen der App | [https://www.triviaengine.com/termsofuse.html](https://www.triviaengine.com/termsofuse.html) |
| Kernfunktionen der App | Verbessern Sie vorhandene Schulungen und verbessern Sie die Wissensaufbewahrung mithilfe &#8220;Gamification-&#8221;. |
| Hauptsitz des Unternehmens | Kanada |
| App-Infoseite | [https://www.triviaengine.com](https://www.triviaengine.com) |
...
Diese Informationen wurden von EnableUC darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Authentifizierungsbibliotheken werden verwendet, wenn Ihre App keine der oben genannten Bibliotheken verwendet? | NV – Die neueste Version von MSAL wird verwendet. |

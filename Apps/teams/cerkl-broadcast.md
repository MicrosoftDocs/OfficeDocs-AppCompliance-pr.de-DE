...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Broadcast, seine Datenverarbeitungsrichtlinien, die Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
Von Cerkl für Microsoft bereitgestellte Informationen:
...
| Kernfunktionen der App | Cerkl Broadcast verbindet Mitarbeitergruppen mit ihrer Organisation&#8217;wichtigen Kommunikation. Mithilfe der verhaltensbasierten Personalisierung übermittelt Broadcast die richtige Nachricht zum richtigen Zeitpunkt im richtigen Kanal an den richtigen Mitarbeiter. Dies&#8217;, wo wir uns wirklich von unserem Wettbewerb unterscheiden – wir ermöglichen versierten Kommunikationsmitarbeitern die Kommunikation über Kanäle hinweg ohne Duplizierung des Aufwands. Broadcast bietet auch branchenführende Metriken, die unseren Kunden helfen, zu wissen, was&#8217;für ihre Zielgruppe funktioniert. |
| Firmenstandort | Vereinigte Staaten von Amerika |
| Seite "App-Informationen" | [https://cerkl.com/broadcast/microsoft-teams/](https://cerkl.com/broadcast/microsoft-teams/) |
...
| Letztes SOC2-Zertifizierungsdatum |  2020-07-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegiert | Die E-Mail-Adresse des Benutzers wird gesammelt und verwendet, um festzustellen, ob sich der Benutzer derzeit in unserem System befindet und von einer Organisation hinzugefügt wurde. | [74ef25ab-3685-446c-aa43-4e9cc251ed62](../azure/74ef25ab-3685-446c-aa43-4e9cc251ed62.md) |

---
title: Anwendungsinformationen für GoLinks von GoLinks
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/18/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für GoLinks, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/c1abaf93-e823-4e9a-a810-34a47e77ef71" target="_blank">Anzeigen im Teams Speicher</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003853" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von GoLinks für Microsoft bereitgestellte Informationen:
...
| Name des Partnerunternehmens | GoLinks |
| Website des Unternehmens | [https://www.golinks.io](https://www.golinks.io) |
| Nutzungsbedingungen der App | [https://www.golinks.io/terms.php](https://www.golinks.io/terms.php) |
| Kernfunktionen der App | GoLinks, die als go-Links, Golinks, go/links oder go-links bezeichnet werden, sind intuitive, leicht zu merkende kurze Links, die von Teams geteilt werden. Es wandelt lange, hässliche URLs in lesbare Go-Links um, die direkt in Browsern, E-Mails, Chats und in Unterhaltungen verwendet werden können. Mit GoLinks können Unternehmen effektiv und effizient auf Arbeitsinformationen und Ressourcen im großen Maßstab zugreifen und diese freigeben. |
| Firmenstandort | Vereinigte Staaten von Amerika |
| Seite "App-Informationen" | [https://www.golinks.io/golinks.php](https://www.golinks.io/golinks.php) |
...
Diese Informationen wurden von GoLinks zur Verfügung gestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden in Ihren Datenbanken gespeichert? | Wir speichern nur die Mandanten-ID von Microsoft. |
...
| Letztes SOC2-Zertifizierungsdatum |  2021-10-31 |
...
| URL der Datenschutzrichtlinie | https://www.golinks.io/privacy.php |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | Anwendung | Wir benötigen Zugriff auf die Nachrichten in öffentlichen Kanälen, um zu überprüfen, ob die Nachricht einen Go/Link enthält. | [c1abaf93-e823-4e9a-a810-34a47e77ef71](../azure/c1abaf93-e823-4e9a-a810-34a47e77ef71.md) |

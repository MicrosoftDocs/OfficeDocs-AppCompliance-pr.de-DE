---
title: Anwendungsinformationen für die mentale Bewegung von The Mental Move B.V.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/02/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für The Mental Move, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "65645650"
---
# <a name="the-mental-move"></a>Die mentale Bewegung

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 16. Februar 2022</p>

* <a href="https://teams.microsoft.com/l/app/c5c971cc-3589-4338-a3be-1326db95cb24" target="_blank">Anzeigen im Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004016" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen von The Mental Move B.V. an Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | Die mentale Bewegung |
| ID | WA200004016 |
| unterstützte Office 365 Clients | Microsoft Teams |
| Name des Partnerunternehmens | Die mentale Bewegung B.V. |
| Website des Unternehmens | [https://www.thementalmove.nl](https://www.thementalmove.nl) |
| Nutzungsbedingungen der App | [https://www.thementalmove.nl/gebruikersvoorwaarden/](https://www.thementalmove.nl/gebruikersvoorwaarden/) |
| Kernfunktionen der App | Snel aan de slag met jouw mentale conditie binnen Teams! |
| Hauptsitz des Unternehmens | Niederlande (die) |
| App-Infoseite | [https://www.thementalmove.nl/ons-aanbod/online-preventiepla...](https://www.thementalmove.nl/ons-aanbod/online-preventieplatform/) |
...
Diese Informationen wurden von The Mental Move B.V. darüber, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| URL der Datenschutzrichtlinie | https://www.thementalmove.nl/privacy-statement/ |

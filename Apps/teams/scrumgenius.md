...
>| User.Read | Delegiert | Name und E-Mail-Adresse des Benutzers. | So ermöglichen Sie dem Benutzer die Anmeldung mit Microsoft Login. | [](https://docs.microsoft.com/microsoft-365-app-certification/azure/) |

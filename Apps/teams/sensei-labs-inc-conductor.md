...
* <a href="https://teams.microsoft.com/l/app/c5418a24-940a-4bf1-a802-8d9e633838fa" target="_blank">Ansicht in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001951" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die Sensei Labs Inc. Microsoft zur Verfügung gestellt hat:
...
| URL der Partner-Website | [https://www.senseilabs.com/conductor/?utm_campaign=msftteam...](https://www.senseilabs.com/conductor/?utm_campaign=msftteamslaunch&amp;utm_source=teamsappsource&amp;utm_medium=createdby&amp;utm_content=conductorlink) |
...
Diese Informationen wurden von Sensei Labs Inc. darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App erfassten Daten hat.
...
>|:-------------------|:-------------------|:--------------------------|:--------------------------|:---------------------------------------------------|:--------------------------|
>| Bot-Framework | Ja | Teams-Instance-ID | Um Teams Instanz der Instanz zuzuordnen, die der Organisation zugeordnet ist  | Teams-Instance-ID | Um Teams Instanz der Instanz zuzuordnen, die der Organisation zugeordnet ist  |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| , um die Person während bot-Gesprächen richtig anzusprechen. Um den Benutzer in Teams seinem Benutzer in unserer Anwendung zuzuordnen | Teams Bezeichner, Name, E-Mail-Adresse | um Teams Benutzer dem Benutzer in unserer Plattform zuzuordnen |
...
>Teams Teammitgliedschaft. Zuordnung zwischen der Teams Instanz des Kunden und deren Conductor-Instanz. Daten werden gespeichert, solange sie ein Conductor-Kunde sind. Entfernen, wenn die Conductor-Instanz des Kunden außer Betrieb genommen wird, oder auf Anfrage
...
<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36367" target="_blank">Anzeigen in einer neuen Registerkarte</a>
...
Diese Informationen wurden von Sensei Labs Inc. zur Verfügung gestellt, wie diese App authentifizierung, Autorisierung, bewährte Methoden für die Anwendungsregistrierung und andere Identitätskriterien verarbeitet.

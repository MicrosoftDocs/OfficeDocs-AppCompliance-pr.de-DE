---
title: Anwendungsinformationen für ContractZen von ContractZen
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/30/2021
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für ContractZen, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/701972b8-c49f-45f9-8cfa-15cbd38cbef5" target="_blank">Anzeigen im Teams Speicher</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001389" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von ContractZen an Microsoft bereitgestellte Informationen:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | ContractZen |
| ID | WA200001389 |
| unterstützte Office 365-Clients | Microsoft Teams |
| Name des Partnerunternehmens | ContractZen |
| Website des Unternehmens | [https://www.contractzen.com](https://www.contractzen.com) |
| Nutzungsbedingungen der App | [https://my.contractzen.com/Terms](https://my.contractzen.com/Terms) |
| Kernfunktionen der App | Sichere Governance-Software für erweiterte Vertragsverwaltung, Board Meeting Management, Entitätsverwaltung, E-Signatur und virtuelle Datenräume (VIRTUAL Data Rooms, VDR) |
| Firmenstandort | Finnland |
| Seite "App-Informationen" | [https://appsource.microsoft.com/en-US/product/office/wa2000...](https://appsource.microsoft.com/en-US/product/office/wa200001389) |
...
Diese Informationen wurden von ContractZen bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| URL der Datenschutzrichtlinie | https://my.contractzen.com/Privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegiert | So können Sie die Benutzerprofilinformationen verwenden | [0492ead3-ee26-40df-9757-d95cc693d856](../azure/0492ead3-ee26-40df-9757-d95cc693d856.md) |

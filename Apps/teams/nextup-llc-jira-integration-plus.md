---
title: Anwendungsinformationen für Jira Integration Plus von Nextup, LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Jira Integration Plus, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
<p>Letzte Aktualisierung durch den Entwickler am: 2. Dezember 2021</p>

* <a href="https://teams.microsoft.com/l/app/a3394b99-8ae6-48cb-bb45-898fd4c49f93" target="_blank">Anzeigen im Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003847" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von Nextup, LLC an Microsoft bereitgestellt werden:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | Jira Integration Plus |
| ID | WA200003847 |
| unterstützte Office 365 Clients | Microsoft Teams |
| Name des Partnerunternehmens | Nextup, LLC |
| Website des Unternehmens | [https://www.nextup.ai](https://www.nextup.ai) |
| Nutzungsbedingungen der App | [https://www.nextup.ai/terms](https://www.nextup.ai/terms) |
| Kernfunktionen der App | Suchen Sie vorhandene Jira-Probleme, die Sie auf Teams bearbeiten oder diskutieren oder neue Probleme erstellen können. Sendet Probleme in einer Nachricht. Kommentieren Sie ein Problem, oder sehen Sie details. Ändern Sie den Status, weisen Sie ihn zu und vieles mehr. Verwenden Sie Jira über eine Befehlszeilenschnittstelle (COMMAND Line Interface, CLI). Kommentieren, Protokollieren von Arbeit und mehr. Abrufen von Benachrichtigungen für Probleme in einem Kanal (Connectors). Erstellen Sie neue Probleme aus Nachrichten mit der Messaging-Erweiterung. Verwalten von Problemen mithilfe von Tafeln (Registerkarten). Suchen Sie nach Problemen, indem Sie auf unser Symbol unter einer beliebigen Nachricht in Teams klicken. |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://www.nextup.ai/microsoft-teams/jira-integration-plus/](https://www.nextup.ai/microsoft-teams/jira-integration-plus/) |
...
Diese Informationen wurden von Nextup, LLC darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Eindeutige Bezeichner und E-Mail-Adressen |
...
| Mehrstufige Authentifizierung (MFA) aktiviert für: | Anmeldeinformationen, DNSManagement |
...
| Neuestes SOC1-Zertifizierungsdatum | 2021-04-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | Beide | Wir verwenden diese API, um zu überprüfen, ob Benutzer über die Berechtigung zum Zugriff auf unsere Anwendung verfügen. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| AccessReview.ReadWrite.All | Beide | Wir verwenden diese API, um zu überprüfen, ob Benutzer über die Berechtigung zum Zugriff auf unsere Anwendung verfügen. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Directory.Read.All | Beide | Wir verwenden diese API, um sicherzustellen, dass Benutzer über die Berechtigung zum Verwenden des Bots in der Teams-Anwendung sowie des Teams und Kanals verfügen. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Directory.Read.All | Beide | Wir verwenden diese API, um sicherzustellen, dass Benutzer über die Berechtigung zum Verwenden des Bots in der Teams-Anwendung sowie des Teams und Kanals verfügen. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Files.ReadWrite.All | Beide | Wir verwenden diese API, um Dateien von Benutzern zu akzeptieren, die sie an Jira-Probleme anfügen können. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Files.ReadWrite.All | Beide | Wir verwenden diese API, um Dateien von Benutzern zu akzeptieren, die sie an Jira-Probleme anfügen können. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Sites.Read.All | Beide | Wir verwenden diese API, um zu sehen, auf welche Websites Benutzer Zugriff haben, damit sie An geeigneten Orten Tickets erstellen können. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Sites.Read.All | Beide | Wir verwenden diese API, um zu sehen, auf welche Websites Benutzer Zugriff haben, damit sie An geeigneten Orten Tickets erstellen können. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| User.ReadWrite.All | Beide | Wir verwenden diese API, um einem Administratorbenutzer die Verwendung unserer Anwendung mit Jira für seine Organisation zu ermöglichen. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| User.ReadWrite.All | Beide | Wir verwenden diese API, um einem Administratorbenutzer die Verwendung unserer Anwendung mit Jira für seine Organisation zu ermöglichen. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |

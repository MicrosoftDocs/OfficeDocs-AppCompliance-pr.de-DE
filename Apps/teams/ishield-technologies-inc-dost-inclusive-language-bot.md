---
title: Anwendungsinformationen für Dost - Inclusive Language Bot von ishield Technologies, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Dost – Inclusive Language Bot, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "66547115"
---
# <a name="dost---inclusive-language-bot"></a>Dost – Inklusiver Sprachbot
...
* <a href="https://teams.microsoft.com/l/app/14a29007-c5ca-4a2d-9228-b0217d8403d7" target="_blank">Im Teams Store anzeigen</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004214" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen von ishield Technologies, Inc. an Microsoft:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | Dost – Inklusiver Sprachbot |
| ID | WA200004214 |
| unterstützte Office 365 Clients | Microsoft Teams |
| Name des Partnerunternehmens | ishield Technologies, Inc. |
| Website des Unternehmens | [https://ishield.ai](https://ishield.ai) |
| Nutzungsbedingungen der App | [https://ishield.ai/terms-of-service/](https://ishield.ai/terms-of-service/) |
| Kernfunktionen der App | Fördern Sie inklusives Workplace Messaging, Zusammenarbeit und Kommunikation innerhalb Ihrer Teams mithilfe von Dost. Wenn Sie Dost zu Ihrem Microsoft Teams-Arbeitsbereich hinzufügen, führt Sie Dost durch Vorschläge und Schulungsmaterial zur Verwendung inklusiver Sprache in Ihren Nachrichten.  Dost zeigt die Lernmomente in Echtzeit an, wenn Benutzer Nachrichten posten, die unbewusste Voreingenommenheit, Mikroaggressionen oder nicht-inklusive Sprache enthalten, mit Empfehlungen zum Ändern und Inklusiveren. |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://getdost.com](https://getdost.com) |
...
Diese Informationen wurden von ishield Technologies, Inc. darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Die App verarbeitet MS Teams-Nachrichten im Teams- und Chatbereich, speichert jedoch keine Benutzernachrichten oder Details. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | Anwendung | Lesen von Nachrichten im Teams-Bereich, um Benutzern Feedback zu nicht inklusiver Sprache zu geben | [01d607db-287c-4354-943d-f015ac938b90](../azure/01d607db-287c-4354-943d-f015ac938b90.md) |
>| ChatMessage.Read.Chat | Anwendung | Lesen von Nachrichten im Chatbereich, um Benutzern Feedback zu nicht inklusiver Sprache zu geben | [01d607db-287c-4354-943d-f015ac938b90](../azure/01d607db-287c-4354-943d-f015ac938b90.md) |

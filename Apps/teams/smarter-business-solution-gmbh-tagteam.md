...
| Kernfunktionen der App | Helfen Sie Ihrem Team, ihre Unterhaltungen in Kanälen mit farbigen Tags zu klassifizieren, damit sie weniger Zeit mit der Suche nach den richtigen Informationen verbringen. Sie werden besonders gerne alle zugehörigen Informationen nur einen Klick entfernt auf den Fingerspitzen haben. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.All | Delegiert | Wir sammeln diese Daten nicht – nur für die Anzeige markierter Unterhaltungen. Wir würden es gerne in die Such-API ändern, aber Graph API unterstützt dies derzeit nicht.  | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](https://docs.microsoft.com/microsoft-365-app-certification/azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b) |
>| User.Read | Delegiert | Anzeigen User-Information (z. B. Name) auf unserer Registerkarte | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](https://docs.microsoft.com/microsoft-365-app-certification/azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b) |
>| User.ReadBasic.All | Delegiert | Anzeigen User-Avatars auf unserer Registerkarte | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](https://docs.microsoft.com/microsoft-365-app-certification/azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b) |
>| openid | Delegiert | Nur für SignIn – es werden keine Daten gespeichert. | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](https://docs.microsoft.com/microsoft-365-app-certification/azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b) |

...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für ServiceDesk Plus Cloud, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/04fdcea1-3511-499c-966d-099d59aef45f" target="_blank">Anzeigen im Teams Speicher</a>
...
| Website des Unternehmens | [https://www.manageengine.com/products/service-desk](https://www.manageengine.com/products/service-desk) |
| Nutzungsbedingungen der App | [https://ondemand.manageengine.com/terms.html](https://ondemand.manageengine.com/terms.html) |
| Kernfunktionen der App | ServiceDesk Plus ist eine SaaS-IT-Helpdesk-Verwaltungssoftware. Mit der Vielzahl von Features für das IT-Dienstmanagement hilft es IT-Managern, helpdesk-Vorgänge innerhalb der Organisation effektiv zu organisieren. ServiceDesk Plus (Cloud) funktioniert standardmäßig mit Azure AD. Registrieren Sie sich zunächst für ServiceDesk Plus (Cloud) mit einem Konto in Ihrer Instanz von Azure AD. |
| Firmenstandort | Vereinigte Staaten von Amerika |
| Seite "App-Informationen" | [https://help.sdpondemand.com/servicedeskplus_cloud_for_teams](https://help.sdpondemand.com/servicedeskplus_cloud_for_teams) |
...
| Auflisten der unterstützten Richtlinientypen | Mehrstufige Authentifizierung, Erfordern von von der Organisation verwalteten Geräten für bestimmte Anwendungen, Blockieren riskanter Anmeldeverhalten, Einschränken des Zugriffs auf andere Personen als die Administratorrollen  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegiert | Anmelden und Benutzerprofil lesen | [127e5be9-da2c-4335-a284-da367379428a](../azure/127e5be9-da2c-4335-a284-da367379428a.md) |
>| offline_access | Delegiert | Den Zugriff auf Daten beibehalten, auf die Sie ihr Zugriff gewährt haben | [127e5be9-da2c-4335-a284-da367379428a](../azure/127e5be9-da2c-4335-a284-da367379428a.md) |

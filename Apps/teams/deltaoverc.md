...
>|:------------------------|:--------------------|:------------------------------------|
>| Group.Read.All | Beide | Alle Gruppen lesen |
>| Group.ReadWrite.All | Beide | Schreib-/Lesezugriff auf alle Gruppen |
>| User.Read | Delegiert | Anmelden und Benutzerprofil lesen |
>| User.Read.All | Anwendung | Vollständiges Profil aller Benutzer lesen |
>| User.ReadWrite | Delegiert | Lese- und Schreibzugriff auf Benutzerprofile |
>| User.ReadWrite.All | Beide | Vollständige Profile aller Benutzer lesen und schreiben |

...
description: Alle verfügbaren Sicherheits- und Compliance-Informationen für Viima, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Compliance-Informationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/2bffa4e8-aac7-4d2e-976d-5a7db5c4b768" target="_blank">Ansicht in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001589" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen von Viima Solutions Oy an Microsoft:
...
| URL der Partner-Website | [https://www.viima.com/](https://www.viima.com/) |
...
Diese Informationen wurden von Viima Solutions Oy darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App erfassten Daten hat.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| User.Read | Delegiert |  Vor- und Nachnamen, UPN/E-Mail-Adresse, Standort, Gebietsschema, Abteilung, Bürostandort. Diese werden verwendet, um den Benutzer in der App anzumelden und grundlegende Profilinformationen für ihn bereitzustellen. | ermöglicht es dem Benutzer, sich anzumelden, und gewährt App-Zugriff auf seine UPN- und grundlegenden Profilinformationen, um eine stille Anmeldung zu ermöglichen | b8ea7030-ce4d-4ecd-98d7-dc16d8298d1b |
...
>Organisationsname, Viima-Organisations-ID, Endbenutzer-E-Mails und IDs werden in Protokollen angezeigt. ISO27001 kompatible von Drittanbietern geprüfte Kontrollen für eingeschränkten Zugriff auf und Archivierung/Löschung dieser Daten.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>Organisationssteuerelemente für vom Partner gespeicherte Daten

Beschreiben Sie, wie Administratoren von Organisationen ihre Informationen in Partnersystemen steuern können? z.B. Löschen, Aufbewahrung, Auditing, Archivierung, Endbenutzerrichtlinie usw.

>Die Daten werden in AWS (Irland) gespeichert. Der Zugriff auf Daten ist auf autorisierteWartungs- und technisches Supportpersonal beschränkt, das eine entsprechende Schulung erhalten hat und mit einer Reihe von Sicherheitsmaßnahmen wie 2FA, geschütztem IP-Bereich (Zugriff nur aus dem Unternehmensnetzwerk) usw. bewacht wird. Maßnahmen sind ISO27001 kompatibel und werden von einem Drittanbieter geprüft.
...
<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/33480" target="_blank">Anzeigen in einer neuen Registerkarte</a>

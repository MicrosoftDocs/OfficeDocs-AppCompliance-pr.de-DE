---
title: Anwendungsinformationen für MyCheckins von Cloud Catalogs LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für MyCheckins, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "66819021"
---
# <a name="mycheckins"></a>MyCheckins

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 7. Juni 2022</p>

* <a href="https://teams.microsoft.com/l/app/6f74dbb7-cd5c-48ac-b3f4-082eabef3808" target="_blank">Im Teams Store anzeigen</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004375" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von Cloud Catalogs LLC an Microsoft bereitgestellt werden:
...
| Name des Partnerunternehmens | Cloud Catalogs LLC |
| Website des Unternehmens | [https://mycheckins.io](https://mycheckins.io) |
| Nutzungsbedingungen der App | [https://mycheckins.io/terms-and-conditions](https://mycheckins.io/terms-and-conditions) |
| Kernfunktionen der App | Führen Sie asynchrone Standups, Retrospektiven und vieles mehr in Microsoft Teams aus. |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://mycheckins.io](https://mycheckins.io) |
...
Diese Informationen wurden von Cloud Catalogs LLC darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Benutzerprofildaten, Benutzer-Email, An den Bot gesendete Benutzernachrichten |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | Benutzerprofildaten, Benutzer-Email, An den Bot gesendete Benutzernachrichten |
...
| URL der Datenschutzrichtlinie | https://mycheckins.io/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Anwendung | Abrufen von Benutzerdetails wie Vorname, Nachname und E-Mail-Adresse | [8f43fc50-571c-4eab-b6ea-675d55e1755e](../azure/8f43fc50-571c-4eab-b6ea-675d55e1755e.md) |

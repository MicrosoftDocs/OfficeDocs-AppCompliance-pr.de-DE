...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für StarLeaf, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/220b3db0-e3be-40df-8148-f0e0c33a986a" target="_blank">Anzeigen in Teams Speicher</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000185" target="_blank">Ansicht in AppSource</a>
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| Der Bot greift auf die Liste des Teams zu, um eine Besprechung im Namen des Benutzers/Hosts zu buchen, der die Besprechung über den Bot reserviert. Auf diese Weise kann StarLeaf eine nahtlose Teilnahme mit einer Schaltfläche für die Teilnahme an Besprechungen ermöglichen. | Vorname, Nachname, E-Mail-Adresse. Dadurch kann der StarLeaf-Bot eine Besprechung im Namen des Benutzers/Hosts, der mit dem Bot interagiert hat, buchen und die anderen Mitglieder des Teams zur Besprechung einladen. |  |

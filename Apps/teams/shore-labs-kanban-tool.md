---
title: Anwendungsinformationen zum Kanban-Tool von Shore Labs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für das Kanban-Tool, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
<p>Letzte Aktualisierung durch den Entwickler am: 15. Juni 2021</p>

* <a href="https://teams.microsoft.com/l/app/b3c15d4f-1972-4836-a1eb-7575dd56a17e" target="_blank">Anzeigen im Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002121" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von Shore Labs an Microsoft bereitgestellt werden:
...
| Website des Unternehmens | [https://www.shorelabs.com](https://www.shorelabs.com) |
| Nutzungsbedingungen der App | [https://kanbantool.com/policy/terms-of-service](https://kanbantool.com/policy/terms-of-service) |
| Kernfunktionen der App | Visualisieren Sie Arbeit, und verfolgen Sie die Zeit auf einem Kanban-Board. |
| Hauptsitz des Unternehmens | Polen |
| App-Infoseite | [https://kanbantool.com](https://kanbantool.com) |
| Was ist die Hostingumgebung oder das Dienstmodell, die zum Ausführen Ihrer App verwendet wird? |  |
| Welche Hosting-Cloudanbieter verwendet die App? | AWS, SelfHosted, GCP |
...
Diese Informationen wurden von Shore Labs darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | Delegiert | E-Mail-Adresse des Benutzers für Kommunikation, Identitätsabgleich und Übermittlung von Benachrichtigungen. | [4e820d60-9e62-403c-accd-857b987cc13c](../azure/4e820d60-9e62-403c-accd-857b987cc13c.md) |
>| Team.ReadBasic.All | Delegiert | Bezeichner und Namen der Teams, bei denen der Benutzer ein direktes Mitglied ist. Sie werden verwendet, um Benutzer automatisch zu korrekten Gruppen im Kanban-Tool zuzuweisen. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| User.Read | Delegiert | Grundlegende Unternehmensinformationen von angemeldeten Benutzern. Es wird verwendet, um die Kontodetails für neue Konten aufzufüllen und Benutzer zu erkennen, die zu Ihrer Organisation gehören, um eine einzelne Sign-On-Funktionalität bereitzustellen. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| offline_access | Delegiert | Ermöglicht die Funktion "Mit Microsoft anmelden" und die Synchronisierung von Daten, auf die Sie der App bei der Anmeldung des Benutzers Zugriff gewährt haben. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| openid | Delegiert | Öffnen Sie ID-Token, mit denen sich Benutzer mit ihren Geschäfts-, Schul- oder Unikonten über die Schaltfläche "Mit Microsoft anmelden" bei der App anmelden können. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| Profil | Delegiert | Benutzername, der im Kanban-Tool automatisch aufgepopuliert und mit Änderungen in Microsoft Teams synchronisiert werden soll. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |

...
* <a href="https://teams.microsoft.com/l/app/ed27363f-755e-4658-b7bf-409d475959d6" target="_blank">Anzeigen im Teams Speicher</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003239" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von ThoughtWire Corp. für Microsoft bereitgestellte Informationen:
...
| URL der Partnerwebsite | [https://thoughtwire.com](https://thoughtwire.com) |
| URL der Datenschutzrichtlinie | [https://thoughtwire.com/privacy-policy](https://thoughtwire.com/privacy-policy) |
| URL der Nutzungsbedingungen | [https://www.thoughtwire.com/end-user-license-agreement/](https://www.thoughtwire.com/end-user-license-agreement/) |
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| Der Benutzername ist erforderlich, um den Benutzer zu identifizieren, der Aktionen ausführt. | Benutzername und Benutzer-ID | Überwachung von Benachrichtigungen und Ereignissen. |
...
>ThoughtWire wählt Partner aus, die unsere eigenen Datenkontrollprozesse treffen oder überschreiten. Daten werden nicht an Partnersysteme übermittelt, es sei denn, dies ist absolut erforderlich. Alle ThoughtWire-Dienste und zugehörige Partnersysteme werden von Kunden überprüft und genehmigt.
...
Diese Informationen wurden von ThoughtWire Corp. darüber bereitgestellt, wie diese App Authentifizierung, Autorisierung, bewährte Methoden für die Anwendungsregistrierung und andere Identitätskriterien behandelt.

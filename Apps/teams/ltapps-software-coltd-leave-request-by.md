...
* <a href="https://teams.microsoft.com/l/app/782cf385-ea23-41ce-828b-832781eec530" target="_blank">Anzeigen im Teams Speicher</a>
...
>Das Add-In speichert keine Informationen des Endbenutzers. Es werden nur zwei Konfigurationsinformationen &amp; unterhalb dieser in Cosmos db Azure gespeichert.
- Mandanten-GUID des Clients
- Die URL der Leave-Anforderung pro-App des Clients 
...
>Die App speichert die Daten des Clients nicht. Alle Daten von Clientspeichern auf der Clientwebsite (Sharepoint-Website).
Daten werden nur über SharePoint Rest-API abgerufen/festgelegt, die &amp; die Azure-App-Registrierung für die Authentifizierung verwendet hat.
...
<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36147" target="_blank">Ansicht auf einer neuen Registerkarte</a>

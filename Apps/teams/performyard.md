---
title: Anwendungsinformationen für PerformYard von PerformYard
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für PerformYard, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "66547107"
---
# <a name="performyard"></a>PerformYard

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 10. Juni 2022</p>

* <a href="https://teams.microsoft.com/l/app/ae947de1-da03-4e37-a420-3c5316f01e73" target="_blank">Im Teams Store anzeigen</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004215" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von PerformYard an Microsoft bereitgestellte Informationen:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | PerformYard |
| ID | WA200004215 |
| unterstützte Office 365 Clients | Microsoft Teams |
| Name des Partnerunternehmens | PerformYard |
| Website des Unternehmens | [https://performyard.com](https://performyard.com) |
| Nutzungsbedingungen der App | [https://www.performyard.com/master-subscription-agreement](https://www.performyard.com/master-subscription-agreement) |
| Kernfunktionen der App | PerformYard erleichtert die Leistungsverwaltung für alle. Flexibel für hr &amp; einfach für Mitarbeiter. |
...
Diese Informationen wurden von PerformYard darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Mandantenidentifikationsinformationen, die Namen aller Teams und aller Kanäle darin; Installations- und Deinstallationsereignisse. |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | Mandantenidentifikationsinformationen, die Namen aller Teams und aller Kanäle darin. |
...
| Neuestes SOC2-Zertifizierungsdatum | 2022-06-01 |
...
| URL der Datenschutzrichtlinie | https://www.performyard.com/privacy |

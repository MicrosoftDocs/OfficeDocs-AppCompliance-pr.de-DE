---
title: Anwendungsinformationen für Leistungserzieler durch Leistungserreichung
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/20/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Achievers, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "66912922"
---
# <a name="achievers"></a>Leistungsträger
...
* <a href="https://teams.microsoft.com/l/app/76903584-359f-4e1e-9f6e-741f48322709" target="_blank">Im Teams Store anzeigen</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000573" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von Leistungserzielern an Microsoft bereitgestellt werden:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | Leistungsträger |
| ID | WA200000573 |
| unterstützte Office 365 Clients | Microsoft Teams |
| Name des Partnerunternehmens | Leistungsträger |
| Website des Unternehmens | [https://www.achievers.com](https://www.achievers.com) |
| Nutzungsbedingungen der App | [https://developer.achievers.com/docs/achievers-terms-of-use](https://developer.achievers.com/docs/achievers-terms-of-use) |
| Kernfunktionen der App | Erstellen Sie anerkennung für Ihre Kollegen in der Achievers-Plattform mit weniger Reibung direkt innerhalb des Microsoft-Ökosystems. |
| Hauptsitz des Unternehmens | Kanada |
| App-Infoseite | [https://www.achievers.com/connect/teams/](https://www.achievers.com/connect/teams/) |
...
Diese Informationen wurden von den Leistungserzielern darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden in Ihren Datenbanken gespeichert? | Mandanten-ID, Benutzer-ID, Benutzer-E-Mail, Benutzergebietsschema, Bot-ID, Bot-Name, Bot-Dienst-URL |
...
| Neuestes SOC2-Zertifizierungsdatum | 2021-12-25 |
...
| URL der Datenschutzrichtlinie | https://over.achievers.com/ilr_privacy_policy |

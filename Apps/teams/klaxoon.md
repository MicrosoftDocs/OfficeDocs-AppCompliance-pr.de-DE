...
Informationen, die Von Klausxoon an Microsoft bereitgestellt werden:
...
| Kernfunktionen der App | In Diesem Artikel erhalten Sie Zugriff auf eine vollständige Suite von Tools für die Zusammenarbeit (Whiteboard, Umfrage, Quizz, Liveumfragen usw.), um die Effizienz der Teamarbeit zu steigern. Auf die Sammlungxoon-Suite kann als Webapp, mobile Apps (Apple/Android) oder direkt über Microsoft Teams (über eine Tab-Integration) zugegriffen werden. |
| Firmenstandort | Frankreich |
| Seite "App-Informationen" | [https://klaxoon.com](https://klaxoon.com) |
| Welche Hostingumgebung oder welches Dienstmodell wird zum Ausführen Ihrer App verwendet? |  |
| Welche Hosting-Cloudanbieter verwendet die App? | AWS, Azure, azurenet |
...
Diese Informationen wurden von Klausxoon darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Letztes SOC2-Zertifizierungsdatum |  2019-10-28 |

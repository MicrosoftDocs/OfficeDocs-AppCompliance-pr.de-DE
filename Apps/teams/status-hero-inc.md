---
title: Anwendungsinformationen für Status Hero von Status Hero, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Status Hero, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/7917afd4-9825-4c1d-b683-ce1fcb77d5b4" target="_blank">Im Teams Store anzeigen</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004205" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Status Hero, Inc. an Microsoft bereitgestellte Informationen:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | Status Hero |
| ID | WA200004205 |
| unterstützte Office 365 Clients | Microsoft Teams |
| Name des Partnerunternehmens | Status Hero, Inc. |
| Website des Unternehmens | [https://statushero.com](https://statushero.com) |
| Nutzungsbedingungen der App | [https://statushero.com/terms](https://statushero.com/terms) |
| Kernfunktionen der App | Status Hero wandelt asynchrone Check-Ins und Daten aus den Tools Ihres Teams in präzise, aufschlussreiche Berichte um. |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://statushero.com/integrations/microsoft-teams](https://statushero.com/integrations/microsoft-teams) |
...
Diese Informationen wurden von Status Hero, Inc. darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Neuestes SOC2-Zertifizierungsdatum | 2021-11-01 |
...
| URL der Datenschutzrichtlinie | https://statushero.com/privacy |

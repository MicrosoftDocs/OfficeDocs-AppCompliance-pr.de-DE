---
title: Bewerbungsinformationen für Myfone von Flexfone
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Myfone, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/5f447fa4-da1f-4651-a0da-d2488a404c19" target="_blank">Anzeigen im Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000716" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Flexfone an Microsoft bereitgestellte Informationen:
...
| App-Infoseite | [https://faq.flexfone.dk/da](https://faq.flexfone.dk/da) |
| Was ist die Hostingumgebung oder das Dienstmodell, die zum Ausführen Ihrer App verwendet wird? |  |
| Welche Hosting-Cloudanbieter verwendet die App? | SelfHosted, Azure |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegiert | Kalender werden verwendet, damit Benutzer ihren Kollegen ihre Kalandar anzeigen und Besprechungen zum Einrichten ihrer Telefonie verwenden können. | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| Contacts.Read | Delegiert | Die Benutzerkontakte können gespeichert werden, wenn sie sie in der App anzeigen möchten, um das Wählen von Kontakten zu vereinfachen. | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| User.Read | Delegiert | Der in dieser Anwendung gelesene Benutzer wird zu Identifikationszwecken verwendet. | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| User.Read | Delegiert | Wir speichern die Daten nicht. Die Anwendung wird einfach zu Authentifizierungszwecken verwendet. | [f0199b83-0ca3-4b41-a23b-d9b234484438](../azure/f0199b83-0ca3-4b41-a23b-d9b234484438.md) |

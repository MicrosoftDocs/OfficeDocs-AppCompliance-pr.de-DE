---
title: Anwendungsinformationen für DailyBot von DailyBot
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/20/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für DailyBot, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "66915653"
---
# <a name="dailybot"></a>DailyBot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 27. April 2022</p>

* <a href="https://teams.microsoft.com/l/app/82bfb2e1-cad3-4e99-8995-5d140f295ef2" target="_blank">Im Teams Store anzeigen</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001492" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von DailyBot an Microsoft bereitgestellte Informationen:
...
| Name des Partnerunternehmens | DailyBot |
| Website des Unternehmens | [https://www.dailybot.com](https://www.dailybot.com) |
| Nutzungsbedingungen der App | [https://www.dailybot.com/legal/terms-and-conditions](https://www.dailybot.com/legal/terms-and-conditions) |
| Kernfunktionen der App | DailyBot reduziert die Notwendigkeit von Besprechungen, indem es Standups, tägliche Statusberichte, Retrospektiven und regelmäßige Check-Ins automatisiert. Es verfolgt die Motivation des Teams und fördert positives Feedback mit Lob und Wertschätzung. DailyBot enthält zusätzliche Features zum Erstellen von Tastenkombinationen/Befehlen und zum Automatisieren Ihrer Chatworkflows. |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://www.dailybot.com/integrations/msteams](https://www.dailybot.com/integrations/msteams) |
...
Diese Informationen wurden von DailyBot darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Benutzer-Email, Mandanten-ID, MS-Teamressourcen-ID und -Name, Teamkanal-IDs |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | Benutzer-Email, Mandanten-ID, MS-Teamressourcen-IDs und -Namen, Teamkanal-IDs, Inhalte von Benutzerantworten, die von den Features und Workflows von DailyBot gesammelt werden, z. B.: Check-Ins, Umfragen, Formulare oder Kudos. |
...
| URL der Datenschutzrichtlinie | https://www.dailybot.com/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegiert | DailyBot erfordert, dass grundlegende Informationen von Benutzern aus Teams gelesen werden. Dies wird verwendet, um eine gute Benutzererfahrung bei Onboarding-Prozessen zu bieten und das Einladen von Membern zu vereinfachen. | [82bfb2e1-cad3-4e99-8995-5d140f295ef2](../azure/82bfb2e1-cad3-4e99-8995-5d140f295ef2.md) |

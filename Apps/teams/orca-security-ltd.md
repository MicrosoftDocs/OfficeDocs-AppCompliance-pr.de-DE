---
title: Anwendungsinformationen für Orca von ORCA SECURITY LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Orca, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/50423b81-408b-4699-a850-9a0514ee42c3" target="_blank">Anzeigen im Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004132" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von ORCA SECURITY LTD an Microsoft bereitgestellte Informationen:
...
| Name des Partnerunternehmens | ORCA SECURITY LTD |
| Website des Unternehmens | [https://orca.security](https://orca.security) |
| Nutzungsbedingungen der App | [https://orca.security/terms-of-use](https://orca.security/terms-of-use) |
| Kernfunktionen der App | Die Orca-Sicherheit für Microsoft Teams bietet ein Echtzeitbild des Sicherheitsstatus Ihrer Cloudumgebung. Mithilfe beider Tools in einer Ansicht können Benutzer eine produktive Diskussion über Sicherheitsprobleme in ihrer Cloudumgebung erstellen Orca-Warnungen geben Details zu einem bestimmten Cloudrisiko an, einschließlich der Ergebnisse des Sicherheitsrisikos und der verbundenen Cloudressource, die das Risiko darstellt. |
...
Diese Informationen wurden von ORCA SECURITY LTD darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Teams Benutzer-ID, Team-ID, Teamname |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | Teams Benutzer-ID, Team-ID, Teamname |
...
| Neuestes SOC2-Zertifizierungsdatum | 2022-04-01 |
...
| URL der Datenschutzrichtlinie | https://orca.security/privacy-policy/ |

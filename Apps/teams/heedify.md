---
title: Anwendungsinformationen für Heedify von Heedify
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/24/2021
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Heedify, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "64877272"
---
# <a name="heedify"></a>Heedify

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 2. August 2021</p>

* <a href="https://teams.microsoft.com/l/app/0587c0da-1445-4875-a9f3-2b8083b7338f" target="_blank">Anzeigen im Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003512" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Heedify an Microsoft bereitgestellte Informationen:
...
| Name des Partnerunternehmens | Heedify |
| Website des Unternehmens | [https://heedify.io](https://heedify.io) |
| Nutzungsbedingungen der App | [https://heedify.io/terms](https://heedify.io/terms) |
| Kernfunktionen der App | Native Rezeptionszentrale und Callcenter-Agent für Microsoft Teams. |
...
Diese Informationen wurden von Heedify darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Anwesenheitsinformationen und Anrufdetails (über das Callcenter)  |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | Anwesenheitsinformationen und Anrufdetails (über das Callcenter)  |
...
| URL der Datenschutzrichtlinie | https://heedify.io/privacy |
...
| Welche Authentifizierungsbibliotheken werden verwendet, wenn Ihre App keine der oben genannten Bibliotheken verwendet? | Wir verwenden ADAL (Javascript), da MSAL die Authentifizierung mit ADFS noch nicht unterstützt  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegiert | Empfangsmitarbeiter müssen den Kalender der Benutzer überprüfen, bevor sie einen Anruf durchweisen oder die Informationen per Telefon mit dem Kunden teilen. | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Contacts.ReadWrite | Delegiert | Die Anwendung muss in der Lage sein, Kontakte zu Benutzer(Agent) hinzuzufügen und ihre Kontakte auch zu lesen  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Contacts.ReadWrite.Shared | Delegiert | Die Anwendung muss in der Lage sein, einen Freigabekontakt mit anderen Benutzern(Agenten) hinzuzufügen und ihre freigegebenen Kontakte ebenfalls zu lesen.  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Presence.Read.All | Delegiert | Die Anwesenheitsinformationen werden für den Contact Center-Agent benötigt, um Anrufe und Kontakte besser verwalten zu können, insbesondere im Falle einer Anrufdurchstellung.  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| User.Read.All | Delegiert | Um den Kontakt zu verwalten, muss der angemeldete Benutzer in der Lage sein, Benutzer zu durchsuchen und seine Informationen einschließlich seines Departements und Vorgesetzten zu lesen (im Falle eines Empfangsmitarbeiters).  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |

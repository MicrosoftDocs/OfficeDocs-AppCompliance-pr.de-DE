...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Heedify, seine Datenverarbeitungsrichtlinien, die Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
| Kernfunktionen der App | Systemeigene Telefonzentrale für Empfangsmitarbeiter und Call Center-Agent für Microsoft Teams. |
...
>|:------------------------|:--------------------|:------------------------------------|
>| Presence.Read.All | Delegiert | Die Anwesenheitsinformationen werden für den Contact Center-Agent benötigt, um Anrufe und Kontakte besser verwalten zu können, insbesondere bei der Anrufübertragung.  |
>| User.Read.All | Delegiert | zum Verwalten des Kontakts muss der protokollierte Benutzer in der Lage sein, Benutzer zu durchsuchen und deren Informationen zu lesen, einschließlich deren Mitarbeitern und Vorgesetzten (im Falle einer Empfangsperson).  |
>| Calendars.Read | Delegiert | Empfangsteilnehmer müssen den Kalender der Benutzer überprüfen, bevor sie einen Anruf übertragen oder die Informationen mit dem Kunden auf dem Telefon teilen können. |
>| Contacts.ReadWrite | Delegiert | Die Anwendung muss in der Lage sein, Kontakte zu User(Agent) hinzuzufügen und ihre Kontakte auch zu lesen.  |
>| Contacts.ReadWrite.Shared | Delegiert | Die Anwendung muss in der Lage sein, einen Freigabekontakt mit einem anderen Benutzer (Agent) hinzuzufügen und auch die freigegebenen Kontakte zu lesen.  |

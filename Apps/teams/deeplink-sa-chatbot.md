---
title: Anwendungsinformationen für Deeplink Chatbot von Deeplink SA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Deeplink Chatbot, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/9f859fc4-0b17-4bf7-abff-f50a73cbe5ab" target="_blank">Im Teams Store anzeigen</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004200" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Deeplink SA an Microsoft bereitgestellte Informationen:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | Deeplink Chatbot |
| ID | WA200004200 |
| unterstützte Office 365 Clients | Microsoft Teams |
| Name des Partnerunternehmens | Deeplink SA |
| Website des Unternehmens | [https://www.deeplink.ai](https://www.deeplink.ai) |
| Nutzungsbedingungen der App | [https://www.deeplink.ai/en/terms/](https://www.deeplink.ai/en/terms/) |
| Kernfunktionen der App | Mit Deeplink können Sie einen vollständig anpassbaren Chatbot einrichten, der auch als Unterhaltungsagent bezeichnet wird, der mit KI unterstützt wird, und auf ihn in Microsoft Teams zugreifen, im Mittelpunkt Ihrer täglichen Interaktionen. Mit Teams fügen Sie einem vorhandenen Assistenten einen neuen Touchpoint hinzu und bieten direkten Zugriff auf erweiterte Dienste wie einen IT-Helpdesk, einen Lernprogramm-Bot oder einen Konfigurations-Agent. |
| Hauptsitz des Unternehmens | Schweiz |
| App-Infoseite | [https://www.deeplink.ai/en/integrations/msteams/](https://www.deeplink.ai/en/integrations/msteams/) |
...
Diese Informationen wurden von Deeplink SA darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.

---
title: Application Information forTed byTED APP S.L.
ms.author: elmalova
author: elenamalova
ms.date: 10/21/2021
ms.topic: article
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für "Ted", die Datenverarbeitungsrichtlinien, die Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "60545940"
---
# <a name="nailted"></a>Bezeilt

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: September 23, 2021</p>

* <a href="https://teams.microsoft.com/l/app/1a199d17-c299-4634-a124-075e0c119d71" target="_blank">Anzeigen in Teams Speicher</a>
...
| Name des Partnerunternehmens | ENTWENNTE APP S.L. |
...
| Wie lange werden Daten nach der Beendigung des Kontos aufbewahrt? | Nicht aufbewahrt |
...
| Melden Sie Verstöße gegen App- oder Dienstdaten innerhalb von 72 Stunden nach der Erkennung an Aufsichtsbehörden und Einzelpersonen, die von der Verletzung betroffen sind?| |
...
| Unterstützt Ihre App die fortlaufende Zugriffsauswertung (Continuous Access Evaluation, CAE) | Ja |
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read.All | Anwendung | Wird zum Lesen von Benutzerinformationen verwendet |
>| email | Anwendung | Zugreifen auf E-Mails von Mitarbeitern, um sie zu synchronisieren |
>| offline_access | Anwendung | Wir verwenden diese Berechtigung, um Zugriff auf die API zu haben, wenn der Benutzer nicht online ist, um Mitarbeiter synchronisieren und die Anwendung installieren zu können. |
>| TeamsAppInstallation.ReadWriteForUser | Anwendung | Der Benutzer kann auswählen, für welche Benutzer die App installiert werden soll. Daher verwenden wir diese Berechtigung zum Instalieren der App. |
>| Directory.Read.All | Anwendung | Wird für den Zugriff auf die Gruppen verwendet. |

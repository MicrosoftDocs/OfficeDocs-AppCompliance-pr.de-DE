---
title: Anwendungsinformationen für "Tedted" von DERTED APP S.L.
ms.author: elmalova
author: elenamalova
ms.date: 10/21/2021
ms.topic: article
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen fürTed, die Datenverarbeitungsrichtlinien, die Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://teams.microsoft.com/l/app/1a199d17-c299-4634-a124-075e0c119d71" target="_blank">Anzeigen im Teams Speicher</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003375" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von DERTED APP S.L. bereitgestellt werden. an Microsoft:
...
| Name des Partnerunternehmens | NAILTED APP S.L. |
| Website des Unternehmens | [https://nailted.com](https://nailted.com) |
| Nutzungsbedingungen der App | [https://nailted.com/legal/terms](https://nailted.com/legal/terms) |
| Kernfunktionen der App | Die Plattform für die Mitarbeitermotivation für moderne Personalteams &amp; . |
| Firmenstandort | Spanien |
| Seite "App-Informationen" | |
| Welche Hostingumgebung oder welches Dienstmodell wird zum Ausführen Ihrer App verwendet? | Paas |
| Welche Hosting-Cloudanbieter verwendet die App? | Heroku |
...
Diese Informationen wurden von DERTED APP S.L. bereitgestellt. Darüber, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden in Ihren Datenbanken gespeichert? | TenantId und E-Mail |
...
| URL der Datenschutzrichtlinie | https://nailted.com/legal/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Anwendung | Wird für den Zugriff auf die Gruppen verwendet. | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](https://docs.microsoft.com/microsoft-365-app-certification/azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7) |
>| TeamsAppInstallation.ReadWriteForUser | Anwendung | Der Benutzer kann auswählen, für welche Benutzer die App installiert werden soll. Daher verwenden wir diese Berechtigung zum Instalieren der App. | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](https://docs.microsoft.com/microsoft-365-app-certification/azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7) |
>| User.Read.All | Anwendung | Wird zum Lesen von Benutzerinformationen verwendet | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](https://docs.microsoft.com/microsoft-365-app-certification/azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7) |
>| email | Anwendung | Zugreifen auf E-Mails von Mitarbeitern, um sie zu synchronisieren | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](https://docs.microsoft.com/microsoft-365-app-certification/azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7) |
>| offline_access | Anwendung | Wir verwenden diese Berechtigung, um Zugriff auf die API zu haben, wenn der Benutzer nicht online ist, um Mitarbeiter synchronisieren und die Anwendung installieren zu können. | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](https://docs.microsoft.com/microsoft-365-app-certification/azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7) |

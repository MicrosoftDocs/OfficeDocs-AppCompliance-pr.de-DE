...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für CrossCheck, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003198" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von kRevealLLC an Microsoft bereitgestellt werden:
...
| Website des Unternehmens | [https://kreveal.com](https://kreveal.com) |
| Nutzungsbedingungen der App | [https://crosscheck.krevealaddins.com/docs/license.htm](https://crosscheck.krevealaddins.com/docs/license.htm) |
| Kernfunktionen der App | CrossCheck optimiert die Dokumentüberprüfung und erkennt häufige Fehler beim Entwerfen. |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://admin.krevealaddins.com/help](https://admin.krevealaddins.com/help) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | Anwendung | Es werden keine Daten gesammelt oder verwendet. | [5edad654-f2d5-41d8-bfc0-92c2735252e1](../azure/5edad654-f2d5-41d8-bfc0-92c2735252e1.md) |

---
title: Anwendungsinformationen für Clausebook von LeasePilot
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Clausebook, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://appsource.microsoft.com/product/office/WA200004044" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von LeasePilot an Microsoft bereitgestellte Informationen:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | Clausebook |
| ID | WA200004044 |
| unterstützte Office 365 Clients | Word 2016 oder höher auf Mac, Word im Web, Word 2016 oder höher unter Windows |
| Name des Partnerunternehmens | LeasePilot |
| Website des Unternehmens | [https://clausebook.com](https://clausebook.com) |
| Nutzungsbedingungen der App | [https://clausebook.com/terms](https://clausebook.com/terms) |
| Kernfunktionen der App | Clausebook ist Ihr Begleiter für die Dokumenterstellung! Es hilft Teams, Formulare und Klauselbibliotheken zu erfassen, zu organisieren, zu entwerfen und freizugeben, um die Organisationspraktiken schnell zu entwerfen und zu institutionalisieren. |
...
| Welche Hosting-Cloudanbieter verwendet die App? | Sonstiges, Vercel |
...
Diese Informationen wurden von LeasePilot darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.

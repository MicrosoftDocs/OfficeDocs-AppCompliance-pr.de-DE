---
title: Anwendungsinformationen für ValidSign by ValidSign
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für ValidSign, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "66817644"
---
# <a name="validsign"></a>ValidSign

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 12. Juli 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001890" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von ValidSign an Microsoft bereitgestellte Informationen:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | ValidSign |
| ID | WA200001890 |
| unterstützte Office 365 Clients | Word 2016 oder höher auf Mac, Word im Web, Word 2013 oder höher unter Windows |
| Name des Partnerunternehmens | ValidSign |
| Website des Unternehmens | [https://www.validsign.eu](https://www.validsign.eu) |
| Nutzungsbedingungen der App | [https://www.validsign.eu/word-license-terms/](https://www.validsign.eu/word-license-terms/) |
| Kernfunktionen der App | Intelligenteres und effizienteres Arbeiten mit dem ValidSign Word-Add-In |
| Hauptsitz des Unternehmens | Niederlande (die) |
| App-Infoseite | [https://www.validsign.eu/connectors/word/](https://www.validsign.eu/connectors/word/) |
...
Diese Informationen wurden von ValidSign darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Neuestes SOC2-Zertifizierungsdatum | 2021-11-22 |
...
| URL der Datenschutzrichtlinie | https://www.validsign.eu/validsign-privacy-statement/ |
| Führt die App automatisierte Entscheidungsfindung durch, einschließlich Profilerstellung, die rechtliche Auswirkungen oder ähnliche Auswirkungen haben könnte? | Ja |

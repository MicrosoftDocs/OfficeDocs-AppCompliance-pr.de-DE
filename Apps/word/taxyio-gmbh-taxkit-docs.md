---
title: Bewerbungsinformationen für TaxKit Docs von Taxy.io GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für TaxKit-Dokumente, die Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "64880852"
---
# <a name="taxkit-docs"></a>TaxKit-Dokumentation
...
* <a href="https://appsource.microsoft.com/product/office/WA200002849" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von Taxy.io GmbH an Microsoft übermittelt werden:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | TaxKit-Dokumentation |
| ID | WA200002849 |
...
| Website des Unternehmens | [https://www.taxy.io](https://www.taxy.io) |
| Nutzungsbedingungen der App | [https://go.microsoft.com](https://go.microsoft.com) |
| Kernfunktionen der App | TaxKit Docs hilft Steuerberatern bei der Suche nach relevanter Rechtsliteratur für das Dokument und den Fall, an dem sie arbeiten. Dies hilft ihnen, ihre Kunden effektiver zu beraten. |
...
Diese Informationen wurden von Taxy.io GmbH darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.

---
title: Anwendungsinformationen für RocketDocs LaunchPad von RocketDocs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für RocketDocs LaunchPad, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "64877032"
---
# <a name="rocketdocs-launchpad"></a>RocketDocs LaunchPad

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 27. Oktober 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003648" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von RocketDocs an Microsoft bereitgestellte Informationen:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | RocketDocs LaunchPad |
| ID | WA200003648 |
| unterstützte Office 365 Clients | Excel 2016 oder höher auf mac, Excel 2016 oder höher auf Windows, Excel im Web, Word 2016 oder höher auf Mac, Word im Web, Word 2016 oder höher auf Windows |
| Name des Partnerunternehmens | RocketDocs |
| Website des Unternehmens | [https://rocketdocs.com](https://rocketdocs.com) |
| Nutzungsbedingungen der App | [https://rocketdocs.com/end-user-license-agreement/](https://rocketdocs.com/end-user-license-agreement/) |
| Kernfunktionen der App | Ermöglicht Es Benutzern, Inhalte auf der RocketDocs-Plattform zu finden und in ein Dokument einzufügen. |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://rocketdocs.com/platform/](https://rocketdocs.com/platform/) |
...
Diese Informationen wurden von RocketDocs darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.

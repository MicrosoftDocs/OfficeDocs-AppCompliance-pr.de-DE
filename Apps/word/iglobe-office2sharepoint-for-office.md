...
| ID | WA104381787 |
| Office 365 unterstützten Clients | Excel 2016 oder höher auf Mac, Excel 2016 oder höher auf Windows, Excel im Web, Word 2016 oder höher auf Mac, Word im Web, Word 2016 oder höher auf Windows, PowerPoint 2016 oder höher auf Mac, PowerPoint im Web, PowerPoint 2016 oder höher Windows |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Directory.AccessAsUser.All | delegierte | In Anwendungsdatenbanken werden keine Daten gespeichert. | Ermöglicht der App den gleichen Zugriff auf Informationen im Verzeichnis wie dem angemeldeten Benutzer. | 5971c986-9d39-409c-a6f8-1385b1f690ef |
>| Directory.Read.All | delegierte | In Anwendungsdatenbanken werden keine Daten gespeichert. | Überprüfen Sie, ob die Berechtigung berechtigt ist, und um die Websites und Listen zu erhalten. Erstellen Sie Ordner, erhalten Sie Dateien, und speichern Sie Dateien. | 5971c986-9d39-409c-a6f8-1385b1f690ef |
>| Directory.ReadWrite.All | delegierte | In Anwendungsdatenbanken werden keine Daten gespeichert. | Überprüfen Sie, ob die Berechtigung berechtigt ist, und um die Websites und Listen zu erhalten. Erstellen Sie Ordner, erhalten Sie Dateien, und speichern Sie Dateien. | 5971c986-9d39-409c-a6f8-1385b1f690ef |
>| Group.Read.All | delegierte | In Anwendungsdatenbanken werden keine Daten gespeichert. | So erhalten Sie die Benutzer Gruppenwebsites. | 5971c986-9d39-409c-a6f8-1385b1f690ef |
>| Group.ReadWrite.All | delegierte | In Anwendungsdatenbanken werden keine Daten gespeichert. | So greifen Sie auf die ausgewählten E-Mails zu, und erhalten Sie die Anlagen. Von der E-Mail oder von SharePoint oder Gruppenwebsite zu der E-Mail hinzufügen. | 5971c986-9d39-409c-a6f8-1385b1f690ef |
>| Mail.ReadWrite | delegierte | In Anwendungsdatenbanken werden keine Daten gespeichert. | So greifen Sie auf die ausgewählten E-Mails zu, und erhalten Sie die Anlagen. Von der E-Mail oder von SharePoint oder Gruppenwebsite zu der E-Mail hinzufügen. | 5971c986-9d39-409c-a6f8-1385b1f690ef |
>| Sites.Manage.All | delegierte | In Anwendungsdatenbanken werden keine Daten gespeichert. | Ermöglicht der Anwendung das Erstellen oder Löschen von Dokumentbibliotheken und Listen in allen Websitesammlungen im Namen des angemeldeten Benutzers. | 5971c986-9d39-409c-a6f8-1385b1f690ef |
>| Sites.Read.All | delegierte | In Anwendungsdatenbanken werden keine Daten gespeichert. | So erhalten Sie die Benutzer SharePoint Website. Dateien erhalten und Anlagen aus der ausgewählten E-Mail speichern. | 5971c986-9d39-409c-a6f8-1385b1f690ef |
>| Sites.ReadWrite.All | delegierte | In Anwendungsdatenbanken werden keine Daten gespeichert. | So erhalten SharePoint, Bibliotheken und Dateien. So speichern Sie Dateien in SharePoint Listen. | 5971c986-9d39-409c-a6f8-1385b1f690ef |
>| User.Read | delegierte | In Anwendungsdatenbanken werden keine Daten gespeichert. | So erhalten Sie die benutzer SharePoint, OneDrive und Gruppenwebsites. | 5971c986-9d39-409c-a6f8-1385b1f690ef |
...
>Alle Anwendungsdaten sind im eigenen Mandanten des Kunden und werden vom Mandantenadministrator wie alle anderen Dienste in Office 365. Im Add-In werden keine Anwendungsdaten gespeichert. Ein modernes Add-In wird in einem Sandkastenbrowser ausgeführt, &#8220;nicht mehr&#8221;. Das Add-In kann nur auf die Daten zugreifen, mit denen der Benutzer arbeitet. Es interagiert mit Benutzerdaten mithilfe Microsoft-Dienste.
...
<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35747" target="_blank">Anzeigen auf einer neuen Registerkarte</a>

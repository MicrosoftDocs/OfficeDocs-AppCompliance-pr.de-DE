...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für MURAL, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "64835330"
---
# <a name="mural"></a>MURAL

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 7. März 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/tactivosincdbamural1608253315049.sol-43803-aek" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von MURAL an Microsoft bereitgestellt werden:
...
| Website des Unternehmens | [https://www.mural.co](https://www.mural.co) |
| Nutzungsbedingungen der App | [https://www.mural.co/terms/terms-of-use](https://www.mural.co/terms/terms-of-use) |
| Kernfunktionen der App | Visuelles Denken und Zusammenarbeiten |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://support.mural.co](https://support.mural.co) |
...
Diese Informationen wurden von MURAL darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | MURAL erfordert nur Name, Nachname und E-Mail-Adresse für Anmeldezwecke. Welche Daten verarbeitet/gespeichert werden sollen, hängt vom Kunden ab. |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | MURAL speichert nur den Vornamen, den Nachnamen und die E-Mail-Adresse des Benutzers zu Anmeldezwecken. Alle anderen gespeicherten Informationen hängen von den Informationen ab, die Kunden in ihren Wandmalereien speichern. |
...
| Neuestes SOC2-Zertifizierungsdatum | 2021-04-01 |
| Entspricht die App den Steuerelementen der Dienstorganisation (SOC 3)? | Ja |
| Neuestes SOC3-Zertifizierungsdatum | 2021-04-01 |
...
| URL der Datenschutzrichtlinie | https://www.mural.co/terms/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | Delegiert | Files.read erforderlich, um Dokumente nach MURAL hochzuladen. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
>| User.Read | Delegiert | User.read, da Wandmalerei Vorname, Nachname und E-Mail für die Kontoerstellung benötigt. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |

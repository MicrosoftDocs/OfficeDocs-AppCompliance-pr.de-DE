...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für umfassende Ideen – Innovationssoftware, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
>|:------------------------|:--------------------|:------------------------------------|
>| TeamsAppInstallation.ReadWriteForTeam | Delegiert | ermöglicht dem Wide Ideas Admin Center das Lesen, Installieren, Aktualisieren und Deinstallieren Teams Apps in Teams, auf die der angemeldete Benutzer zugreifen kann.  |
>| Channel.Create | Delegiert | ermöglicht wide Ideas Admin Center das Erstellen eines Kanals in einem beliebigen Team im Namen des angemeldeten Benutzers.  |
>| TeamsTab.Create | Delegiert |  ermöglicht dem Wide Ideas Admin Center, Registerkarten in jedem Team in Microsoft Teams im Namen des angemeldeten Benutzers zu erstellen. |
>| Directory.Read.All | Delegiert | ermöglicht dem Wide Ideas Admin Center das Lesen von Daten im Verzeichnis Ihrer Organisation&#8217;, z. B. Benutzer, Gruppen und Apps |
>| Group.Read.All | Delegiert | ermöglicht dem Wide Ideas Admin Center, Gruppen aufzuführen und deren Eigenschaften und alle Gruppenmitgliedschaften im Namen des angemeldeten Benutzers zu lesen. |
>| User.Read | Delegiert | ermöglicht Benutzern die Anmeldung beim Wide Ideas Admin Center und ermöglicht der App, das Profil der angemeldeten Benutzer zu lesen.  |

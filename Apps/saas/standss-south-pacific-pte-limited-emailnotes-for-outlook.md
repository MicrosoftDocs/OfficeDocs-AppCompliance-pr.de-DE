---
title: Anwendungsinformationen für EmailNotes für Outlook von Ständer (Südpazifik) PTE Limited
ms.author: elmalova
author: elenamalova
ms.date: 12/10/2021
ms.topic: article
...
Informationen von Ständern (Südpazifik) PTE beschränkt auf Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | EmailNotes for Outlook |
| ID | standsssouthpacificltd1581455821226.emailnotes |
| Name des Partnerunternehmens | Ständer (Südpazifik) PTE Limited |
| Website des Unternehmens | [https://www.standss.com](https://www.standss.com) |
...
| Kernfunktionen der App | SendGuard für Outlook M365 ist ein Tool für Risiken und Compliance, mit dem Benutzer vertrauliche, vertrauliche oder unangemessene Informationen per E-Mail an unbeabsichtigte Empfänger erkennen, auffordern, warnen und schützen können. |
...
Diese Informationen wurden von Stand (Südpazifik) PTE Limited darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| URL der Datenschutzrichtlinie | http://www.standss.com/sr/sg_m365/privacy_policy.asp |
...
| Auflisten der unterstützten Richtlinientypen | Erfordern der mehrstufigen Authentifizierung für Benutzer in Administratorrollen |
...
>|:------------------------|:--------------------|:------------------------------------|
>| Calendars.ReadWrite | Delegiert | So lesen Sie Inhalte aus Betreff, Text, Inhalten von Anlagen, die an die Besprechungsanfrage angefügt sind  |
>| Mail.ReadWrite | Delegiert | So lesen Sie Inhalte des Betreffs, des Textkörpers, des Inhalts von Anlagen, die dem E-Mail-Element angefügt sind  |
>| openid | Delegiert | Anforderung für die Berechtigung für einmaliges Anmelden (Single Sign-On, SSO) |
>| Profil | Delegiert | Anforderung für die Berechtigung für einmaliges Anmelden (Single Sign-On, SSO) |
>| User.Read | Delegiert | Dies ist das Lesen von Benutzerdaten, um Lizenzierungsinformationen für ihre Domäne/ihr Benutzerkonto zu überprüfen. |

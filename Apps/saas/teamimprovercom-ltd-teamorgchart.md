---
title: Anwendungsinformationen für TeamOrgChart von TeamImprover.Com Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/14/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für TeamOrgChart, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "64859775"
---
# <a name="teamorgchart"></a>TeamOrgChart

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 21. März 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/teamorgchart.66763c6e-79ef-434a-b4b5-8c64c980ac13" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von TeamImprover.Com Ltd. an Microsoft bereitgestellte Informationen:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | TeamOrgChart |
| ID | teamorgchart.66763c6e-79ef-434a-b4b5-8c64c980ac13 |
| Name des Partnerunternehmens | TeamImprover.Com Ltd |
| Website des Unternehmens | [https://teamimprover.com](https://teamimprover.com) |
| Nutzungsbedingungen der App | [https://teamorgchart.com/termsofservice](https://teamorgchart.com/termsofservice) |
| Kernfunktionen der App | Erstellen, Freigeben, Suchen und Drucken von Organigrammen |
| Hauptsitz des Unternehmens | Vereinigtes Königreich Großbritannien und Nordirland (die) |
| App-Infoseite | [https://teamorgchart.com/website/features.cshtml](https://teamorgchart.com/website/features.cshtml) |
...
Diese Informationen wurden von TeamImprover.Com Ltd. darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Organisationshierarchieinformationen werden von der Anwendung verarbeitet.   |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | TeamOrgChart speichert die Metadaten, die das Diagramm beschreiben, z. B. den Diagrammnamen, Regeln, Textmarken, die Anzahl der Anzeigeebenen usw. |
...
| URL der Datenschutzrichtlinie | https://teamorgchart.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Delegiert | Anwendung erstellt und zeigt ein Organigramm aus Azure AD an.  Benutzerinformationen müssen aus Azure AD gelesen werden können.  | [b12699ab-e60a-46b1-8c9e-231d489947aa](../azure/b12699ab-e60a-46b1-8c9e-231d489947aa.md) |
>| User.Read.All | Delegiert | Anwendung erstellt und zeigt ein Organigramm aus Azure AD an.  Benutzerinformationen müssen aus Azure AD gelesen werden können.  | [b12699ab-e60a-46b1-8c9e-231d489947aa](../azure/b12699ab-e60a-46b1-8c9e-231d489947aa.md) |

---
title: Anwendungsinformationen für Theta Lake Recording &amp; Compliance für Teams Video von Theta Lake
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Theta Lake Recording &amp; Compliance für Teams Video, seine Datenverarbeitungsrichtlinien, die Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://appsource.microsoft.com/product/web-apps/thetalake.thetalake_recording_and_compliance_for_teams" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Theta Lake für Microsoft bereitgestellte Informationen:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | Theta Lake Recording &amp; Compliance für Teams Video |
| ID | thetalake.thetalake_recording_and_compliance_for_teams |
| Name des Partnerunternehmens | Theta Lake |
...
Diese Informationen wurden von Theta Lake bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Letztes SOC2-Zertifizierungsdatum |  2021-08-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.JoinGroupCall.All | Delegiert | Graph API muss Zugriff haben, um Anrufdaten zu empfangen | [1cc8eecf-56f3-4137-a0fe-4b0466ca0677](../azure/1cc8eecf-56f3-4137-a0fe-4b0466ca0677.md) |

---
title: Anwendungsinformationen für Adobe Acrobat Sign for Microsoft 365 von Adobe
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/20/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Adobe Acrobat Sign for Microsoft 365, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
<p>Letzte Aktualisierung durch den Entwickler am: 11. April 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/adobe.adobe_sign_msft_saas_offer" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Adobe an Microsoft bereitgestellte Informationen:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | Adobe Acrobat Sign for Microsoft 365 |
| ID | adobe.adobe_sign_msft_saas_offer |
| Name des Partnerunternehmens | Adobe |
...
| Kernfunktionen der App | Sorgen Sie dafür, dass Dokumentsignierungsworkflows beim Hinzufügen von Adobe Sign zu Office-Outlook-Team schnell ausgeführt werden. Aus diesen Produkten können Sie Dokumente für rechtsverbindliche E-Signaturen und Genehmigungen &#8212; alle mit der von Microsoft bevorzugten E-Sign-Lösung senden und signen. |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://helpx.adobe.com/sign/using/microsoft-teams-integrat...](https://helpx.adobe.com/sign/using/microsoft-teams-integration-user-guide.html) |
...
Diese Informationen wurden von Adobe darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | So aktualisieren Sie das Zugriffstoken, wenn das aktuelle abgelaufen ist. Wenn sich der Benutzer beispielsweise in einem &quot;Fenster "Senden für Signatur&quot; " befindet und es zu lange inaktiv lässt, müssen wir ein neues Token aktualisieren, wenn der Benutzer aktiv ist. |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | So aktualisieren Sie das Zugriffstoken, wenn das aktuelle abgelaufen ist. Wenn sich der Benutzer beispielsweise in einem &quot;Fenster "Senden für Signatur&quot; " befindet und es zu lange inaktiv lässt, müssen wir ein neues Token aktualisieren, wenn der Benutzer aktiv ist. |
...
| Neuestes SOC2-Zertifizierungsdatum | 2020-11-24 |
...
| URL der Datenschutzrichtlinie | https://helpx.adobe.com/sign/help/adobesign_gdpr_compliance.html |
...
| Welche Authentifizierungsbibliotheken werden verwendet, wenn Ihre App keine der oben genannten Bibliotheken verwendet? | adal (mit Plan für den Wechsel zu MSAL) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Mail.ReadWrite | Delegiert | So füllen Sie das angefügte Dokument, Absender- und Empfänger-E-Mails und Nachrichteninhalte von E-Mails an Adobe Sign auf, um sie zur Signatur zu senden. Dies dient dazu, dem Benutzer Zeit zum erneuten Eingeben dieser Felder in Adobe Sign zu sparen. Nachdem eine Vereinbarung unterzeichnet wurde, erstellen wir automatisch eine neue E-Mail für den Benutzer, um eine E-Mail zu senden, um seine Empfänger darüber zu informieren, dass die Transaktion abgeschlossen ist. Adobe Sign speichert die Anlagen als temporäre Dateien, deren Ablauf 24 Stunden beträgt. | [ea36b867-ca67-45fd-a61b-d2be86273167](../azure/ea36b867-ca67-45fd-a61b-d2be86273167.md) |
>| People.Read | Delegiert | Wenn Sie die E-Mail-Adresse in der &quot;Benutzeroberfläche "Für Signatur&quot; senden" automatisch ausfüllen möchten, indem Sie einige Anfangsbuchstaben eingeben, müssen Benutzer nicht die gesamten E-Mails eingeben. Adobe Sign speichert nur E-Mail- und DisplayName-Empfänger in den Vereinbarungen. | [ea36b867-ca67-45fd-a61b-d2be86273167](../azure/ea36b867-ca67-45fd-a61b-d2be86273167.md) |
>| User.Read | Delegiert | Um das Profil des Benutzers zu lesen und sein Profil (im Wesentlichen seine E-Mail und userId) mit unserer Datenbank abzugleichen, damit er Adobe Sign verwenden kann. Um das Profil des Benutzers zu lesen und sein Profil (im Wesentlichen seine E-Mail und userId) mit unserer Datenbank abzugleichen, damit er Adobe Sign verwenden kann. | [ea36b867-ca67-45fd-a61b-d2be86273167](../azure/ea36b867-ca67-45fd-a61b-d2be86273167.md) |
>| offline_access | Delegiert | So aktualisieren Sie das Zugriffstoken, wenn das aktuelle abgelaufen ist. Wenn sich der Benutzer beispielsweise in einem &quot;Fenster "Senden für Signatur&quot; " befindet und es zu lange inaktiv lässt, müssen wir ein neues Token aktualisieren, wenn der Benutzer aktiv ist. So aktualisieren Sie das Zugriffstoken, wenn das aktuelle abgelaufen ist. Wenn sich der Benutzer beispielsweise in einem &quot;Fenster "Senden für Signatur&quot; " befindet und es zu lange inaktiv lässt, müssen wir ein neues Token aktualisieren, wenn der Benutzer aktiv ist. | [ea36b867-ca67-45fd-a61b-d2be86273167](../azure/ea36b867-ca67-45fd-a61b-d2be86273167.md) |
>| openid | Delegiert | E-Mail und UserId. So melden Sie sich an, um ihre Zustimmung für die Berechtigung zur Verwendung der Adobe Sign-App sicherzustellen. E-Mail ist der eindeutige Bezeichner für Benutzer in Adobe Sign. Wir speichern die E-Mail-ID, damit wir alle Aktivitäten dieses Benutzers seinem Adobe Sign-Eintrag zuordnen können. | [ea36b867-ca67-45fd-a61b-d2be86273167](../azure/ea36b867-ca67-45fd-a61b-d2be86273167.md) |

---
title: Anwendungsinformationen für callCabinet Atmos Compliance Recording and Analytics von CallCabinet Corporation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für CallCabinet Atmos Compliance Recording and Analytics, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "66704004"
---
# <a name="callcabinet-atmos-compliance-recording-and-analytics"></a>Aufzeichnung und Analyse der CallCabinet Atmos Compliance
...
* <a href="https://appsource.microsoft.com/product/web-apps/callcabinetcorporation1584393576335.atmos" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von CallCabinet Corporation an Microsoft bereitgestellt werden:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | Aufzeichnung und Analyse der CallCabinet Atmos Compliance |
...
| Kernfunktionen der App | Atmos von CallCabinet ist eine azure-native Compliance-Anrufaufzeichnung, AI-Analyse- und QA-SaaS-Lösung für Microsoft Teams und andere Systeme für die Zusammenarbeit oder das Contact Center. |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://www.callcabinet.com/compliance-microsoft-teams-call...](https://www.callcabinet.com/compliance-microsoft-teams-call-recording/) |
...
Diese Informationen wurden von der CallCabinet Corporation darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Aufgezeichnete Teams-Unterhaltungen, Video- und Bildschirmfreigabe |

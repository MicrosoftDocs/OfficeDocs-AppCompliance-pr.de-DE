---
title: Anwendungsinformationen für Talkdesk Microsoft Teams Connector von Talkdesk, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für Talkdesk Microsoft Teams Connector, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://appsource.microsoft.com/product/web-apps/talkdeskinc1579824950513.talkdesk_for_teams" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Talkdesk, Inc. an Microsoft bereitgestellte Informationen:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | Talkdesk Microsoft Teams Connector |
| ID | talkdeskinc1579824950513.talkdesk_for_teams |
| Name des Partnerunternehmens | Talkdesk, Inc. |
| Website des Unternehmens | [https://www.talkdesk.com](https://www.talkdesk.com) |
| Nutzungsbedingungen der App | [https://www.talkdesk.com/terms-of-service](https://www.talkdesk.com/terms-of-service) |
| Kernfunktionen der App | Microsoft Teams-Integration in Talkdesk, die verzeichnis- und direktes Routing ermöglicht |
...
Diese Informationen wurden von Talkdesk, Inc. darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Welche Daten werden von Ihrer App verarbeitet? | Benutzerprofildaten – Vorname, Nachname, Vollständiger Name, E-Mail-Adresse, Telefonnummer |
| Unterstützt die App TLS 1.1 oder höher? | Ja |
| Speichert die App oder die zugrunde liegende Infrastruktur Microsoft-Kundendaten? | Ja |
| Welche Daten werden in Ihren Datenbanken gespeichert? | Benutzerprofildaten – Vorname, Nachname, Vollständiger Name, E-Mail-Adresse, Telefonnummer |
...
| Neuestes SOC2-Zertifizierungsdatum | 2021-02-22 |
| Entspricht die App den Steuerelementen der Dienstorganisation (SOC 3)? | Ja |
| Neuestes SOC3-Zertifizierungsdatum | 2021-02-22 |
...
| Welche Authentifizierungsbibliotheken werden verwendet, wenn Ihre App keine der oben genannten Bibliotheken verwendet? | https://rubygems.org/gems/oauth2, v1.4.4 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | Delegiert | Erforderlich zum Sammeln der Profildaten von MS Teams-Benutzern | [10d8604b-e6ea-4c59-8414-aca1bf1ffda8](../azure/10d8604b-e6ea-4c59-8414-aca1bf1ffda8.md) |
>| offline_access | Delegiert | Ermöglicht der App, die Daten auch dann anzuzeigen, wenn der Benutzer, der den Zugriff gewährt hat, nicht angemeldet ist. | [10d8604b-e6ea-4c59-8414-aca1bf1ffda8](../azure/10d8604b-e6ea-4c59-8414-aca1bf1ffda8.md) |
...
| [**DATENSCHUTZ IM UMGANG MIT DATEN &amp;**](../docs/certification-submission-guide.md#data-handling-security-and-privacy) | **FAIL** |

...
<p>Zuletzt aktualisiert vom Entwickler am: 9. Februar 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/talkdeskinc1579824950513.talkdesk_for_teams" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von Talkdesk, Inc. für Microsoft bereitgestellte Informationen:
...
| Kernfunktionen der App | Microsoft Teams Integration in Talkdesk, die verzeichnisbasiertes und direktes Routing ermöglicht |
...
Diese Informationen wurden von Talkdesk, Inc. zur Verfügung gestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Letztes SOC2-Zertifizierungsdatum |  2021-02-22 |
| Entspricht die App den Dienstorganisationssteuerelementen (SOC 3)? | Ja |
| Letztes SOC3-Zertifizierungsdatum |  2021-02-22 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | Delegiert | Erforderlich, um ms Teams Profildaten der Benutzer zu sammeln | [10d8604b-e6ea-4c59-8414-aca1bf1ffda8](https://docs.microsoft.com/microsoft-365-app-certification/azure/10d8604b-e6ea-4c59-8414-aca1bf1ffda8) |
>| offline_access | Delegiert | Ermöglicht der App, die Daten auch dann anzuzeigen, wenn der Benutzer, dem der Zugriff gewährt wurde, nicht angemeldet ist. | [10d8604b-e6ea-4c59-8414-aca1bf1ffda8](https://docs.microsoft.com/microsoft-365-app-certification/azure/10d8604b-e6ea-4c59-8414-aca1bf1ffda8) |

---
title: Anwendungsinformationen für Cloud Contact Center Teams Integration von Content(n)
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für das Cloud Contact Center Teams Integration, seine Datenverarbeitungsrichtlinien, die Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "63551694"
---
# <a name="storm-cloud-contact-center-teams-integration"></a>Cloud Contact Center Teams Integration

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: March 10, 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/contentguru1616168120869.storm_cloud_contact_center_teams_integration" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die Von Content Wiesn an Microsoft bereitgestellt werden:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | Cloud Contact Center Teams Integration |
| ID | contentguru1616168120869.storm_cloud_contact_center_teams_integration |
| Name des Partnerunternehmens | Content Wiesn |
...
| Kernfunktionen der App | Integrieren Sie das Cloud Contact Center in Microsoft Teams für eine einheitliche CCaaS-Lösung. |
| Firmenstandort | Vereinigtes Königreich Großbritannien und Nordirland (die) |
| Seite "App-Informationen" | [https://www.contentguru.com/microsoft-teams-integration/](https://www.contentguru.com/microsoft-teams-integration/) |
...
Diese Informationen wurden von Content Dataset bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.

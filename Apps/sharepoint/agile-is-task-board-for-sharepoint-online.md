---
title: Anwendungsinformationen zum Agile Task Board für SharePoint Online von Agile-IS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/08/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für das Agile Task Board für SharePoint Online, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
<p>Letzte Aktualisierung durch den Entwickler am: 8. April 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002087" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von Agile-IS an Microsoft bereitgestellt werden:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | Agile Task Board für SharePoint Online |
| ID | WA200002087 |
| unterstützte Office 365 Clients | SharePoint 2016 oder höher |
| Name des Partnerunternehmens | Agile-IS |
| Website des Unternehmens | [https://www.agile-is.de](https://www.agile-is.de) |
| Nutzungsbedingungen der App | [https://www.agile-is.de/en/termsofuse](https://www.agile-is.de/en/termsofuse) |
| Kernfunktionen der App | Das Agile Task Board hilft Ihnen und Ihrem Team, einen besseren Überblick über Ihr agiles Projekt zu erhalten. Konvertieren Sie Ihr physisches Board in eine digitale Version. Sie können Ihren Prozess mit Features wie Spalten für die Statusanzeige, einer beliebigen Anzahl von Verantwortlichkeiten, der metadatengesteuerten Färbung von Karten, der Zuweisung von Zuständigkeiten, der Drag&Drop-Bearbeitung und vielen anderen Einstellungen zuordnen. Alle Ihre Daten verbleiben in Ihrem M365-Mandanten. |
| Hauptsitz des Unternehmens | Deutschland |
| App-Infoseite | [https://www.agile-is.de/en/agiletaskboard](https://www.agile-is.de/en/agiletaskboard) |
...
| Welche Daten werden in Ihren Datenbanken gespeichert? | UPN es zur Lizenzverwaltung; Unternehmensdaten zur Rechnungslegung |
...
| URL der Datenschutzrichtlinie | https://www.agile-is.de/en/telemetry |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Delegiert | Ermöglicht der App, die aktuell installierte App-Verion abzufragen. Wird verwendet, um die richtigen App-Ressourcen bereitzustellen. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| GroupMember.Read.All | Delegiert | Lesen von Gruppenmitgliedern zum Zuweisen von Planner-Aufgaben  | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| Tasks.ReadWrite | Delegiert | Arbeiten mit Plan und Aufgabe von Planner   | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsActivity.Send | Delegiert | Senden von Nachrichten an Teams-Aktivitäten | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsAppInstallation.ReadForTeam | Delegiert | Ermöglicht der App, die aktuell installierte App-Verion abzufragen. Wird verwendet, um die richtigen App-Ressourcen bereitzustellen. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.Read | Delegiert | Ermöglicht dem Benutzer, sich anzumelden und grundlegende Profilinformationen zu lesen. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.ReadBasic.All | Delegiert | Ermöglicht dem Benutzer, grundlegende Profilinformationen anderer Benutzer zu lesen. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |

---
title: Anwendungsinformationen für 4Mata - Listenformatierungs-Designer von CLOUDIGNITE LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für 4Mata – Listenformatierungs-Designer, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
---
# <a name="4mata---list-formatting-designer"></a>4Mata - Listenformatierungs-Designer
...
* <a href="https://appsource.microsoft.com/product/office/WA200002892" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von CLOUDIGNITE LLC an Microsoft bereitgestellt werden:

| **Information** | **Antwort** |
|:----------------|:-------------|
| App-Name | 4Mata - Listenformatierungs-Designer |
| ID | WA200002892 |
| unterstützte Office 365 Clients | SharePoint 2016 oder höher |
| Name des Partnerunternehmens | CLOUDIGNITE LLC |
| Website des Unternehmens | [https://4mata.com](https://4mata.com) |
| Nutzungsbedingungen der App | [https://docs.4mata.com/legal/terms-of-service](https://docs.4mata.com/legal/terms-of-service) |
| Kernfunktionen der App | 4Mata von CloudIgnite ist eine Reihe von Tools, mit denen Unternehmen Daten visualisieren können, indem sie SharePoint Listen und Formulare entwerfen und formatieren.  Mit dieser Anwendung können Benutzer hoch angepasste komplexe SharePoint Formulare und Listen für Berichte, Rechnungen, Veröffentlichung von Produktdetails und Kontaktinformationen intuitiv konfigurieren, um sie bequem in Ihre Geschäftsprozesse integrieren zu können.  |
| Hauptsitz des Unternehmens | USA Amerikas |
| App-Infoseite | [https://4mata.com](https://4mata.com) |
...
Diese Informationen wurden von CLOUDIGNITE LLC darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.
...
| Mehrstufige Authentifizierung (MFA) aktiviert für: | Anmeldeinformationen, DNSManagement, CodeRepositories |

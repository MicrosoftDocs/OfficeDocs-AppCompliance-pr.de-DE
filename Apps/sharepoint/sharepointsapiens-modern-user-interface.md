---
title: Anwendungsinformationen für SharePoint|sapiens Modern User Interface von SharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für SharePoint|sapiens Modern User Interface, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
---
# <a name="sharepointsapiens-modern-user-interface"></a>moderne Benutzeroberfläche von SharePoint|sapiens

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: March 30, 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003529" target="_blank">Ansicht in AppSource</a>
...
|:----------------|:-------------|
| App-Name | moderne Benutzeroberfläche von SharePoint-sapiens |
| ID | WA200003529 |
...
| Kernfunktionen der App | Diese App muss in Verbindung mit unserer SharePoint|sapiens-Ereignisverwaltungs-App (WA104380834) oder SharePoint|sapiens Employee Training Management-App (WA104380833).  Diese App bietet eine intuitive Benutzeroberfläche, mit der Sie Ereignisse, Themen, Kurse und Lehrpläne in SharePoint erstellen und verwalten, Benutzer registrieren oder sich selbst registrieren und alle Teilnehmer, Aufgaben und Erfolge nachverfolgen können. |

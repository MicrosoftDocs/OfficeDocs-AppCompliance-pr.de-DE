...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für taxonomie, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "64870953"
---
# <a name="taxonomy"></a>Taxonomie

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Letzte Aktualisierung durch den Entwickler am: 18. Februar 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003006" target="_blank">Anzeigen in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Informationen, die von Accuracy Software Inc. an Microsoft bereitgestellt werden:
...
| Kernfunktionen der App | Taxonomie bietet Ihnen eine effektive Möglichkeit zum Verwalten Ihres Dateiklassifizierungsplans, indem die Zusammenarbeit der Chatexperten mit den verschiedenen Projektbeteiligten ermöglicht wird, um den Dateiplan für die gesamte Organisation zu erstellen, zu überprüfen und zu veröffentlichen. Darüber hinaus können Sie mithilfe der Taxonomie den Export von M365-Aufbewahrungsbezeichnungen generieren, den Sie in das Microsoft Compliance Center importieren können, und Ihren Dateiplan in einem Ausdruckssatzformat exportieren, das Sie in die SharePoint Term Store importieren können. |
| Hauptsitz des Unternehmens | Kanada |
| App-Infoseite | [https://www.accuracysoftware.ca/taxonomy-sharepoint-webpart/](https://www.accuracysoftware.ca/taxonomy-sharepoint-webpart/) |
...
Diese Informationen wurden von Accuracy Software Inc. darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.

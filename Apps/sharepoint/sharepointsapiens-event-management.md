---
title: Anwendungsinformationen für SharePoint|sapiens Event Management by SharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für SharePoint|sapiens Event Management, seine Datenverarbeitungsrichtlinien, Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "63778416"
---
# <a name="sharepointsapiens-event-management"></a>SharePoint|sapiens-Ereignisverwaltung

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Zuletzt aktualisiert vom Entwickler am: 22. März 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380834" target="_blank">Ansicht in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Allgemeine Informationen

Von SharePointSapiens für Microsoft bereitgestellte Informationen:

| **Information** | **Response** |
|:----------------|:-------------|
| App-Name | SharePoint-sapiens-Ereignisverwaltung |
| ID | WA104380834 |
| unterstützte Office 365-Clients | SharePoint 2016 oder höher |
| Name des Partnerunternehmens | SharePointSapiens |
...
| Kernfunktionen der App | Das Ereignisverwaltungs-Add-In hilft Ihnen bei der Organisation verschiedener Ereignistypen. Ereignisse können in wenigen einfachen Schritten in kurzer Zeit geplant werden. Teilnehmer können sich mit nur einem Klick online registrieren. Als Organisator können Sie auch interne oder externe Benutzer im Namen registrieren oder Einladungen per E-Mail senden. Teilnehmer erhalten Besprechungsanfragen und Updates per E-Mail, um sicherzustellen, dass sie immer die neuesten Informationen in ihrem Outlook Kalender haben. Das Add-In verfolgt alle Teilnehmer an einem Ort. |
| Firmenstandort | Österreich |
| Seite "App-Informationen" | [https://www.sharepointsapiens.com/event-management-office36...](https://www.sharepointsapiens.com/event-management-office365/) |
...
Diese Informationen wurden von SharePointSapiens darüber bereitgestellt, wie diese App Organisationsdaten sammelt und speichert und welche Kontrolle Ihre Organisation über die von der App gesammelten Daten hat.

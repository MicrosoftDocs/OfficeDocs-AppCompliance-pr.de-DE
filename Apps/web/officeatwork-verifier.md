---
title: Anwendungsinformationen für Verifier
ms.author: elmalova
author: elenamalova
ms.date: 06/23/2021
ms.topic: article
...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für den Verifier, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
ms.locfileid: "65225289"
---
# <a name="application-information-for-verifier-by-officeatwork"></a>Anwendungsinformationen für verifier by officeatwork
...
* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork-ag.verifier" target="_blank">Anzeigen in AppSource</a>
...
>| Sites.Read.All | Delegiert | Es werden keine Daten gespeichert. | SharePoint Online: Zum Aktivieren des Lesens von Daten aus SharePoint Online hat der angemeldete Benutzer Zugriff. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| User.Read | Delegiert | Es werden keine Daten gespeichert. | Anmelden: Um der officeatwork-App das Lesen der grundlegenden Eigenschaften des Benutzers zu ermöglichen. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| offline_access | Delegiert | Es werden keine Daten gespeichert. | Anmeldung: Um die automatische Anmeldung über Aktualisierungstoken zu aktivieren, wie ohne, müssten sich Benutzer jedes Mal manuell anmelden, wenn sie die officeatwork-App starten. Dieser Bereich ist nur für Nicht-SSO-aktivierte Hostanwendungen erforderlich. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| openid | Delegiert | Es werden keine Daten gespeichert. | Sing-In: Benutzer können sich mit ihrem Organisations- und/oder Microsoft-Konto bei der officeatwork-App anmelden. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| Profil | Delegiert | Es werden keine Daten gespeichert. | Sing-In: Zum Anzeigen des angemeldeten Benutzers in der officeatwork-App. Dadurch kann sichergestellt/bestätigt werden, welches Konto für die Anmeldung bei der officeatwork-App verwendet wurde. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
...
<iframe height='1020' title='Microsoft Cloud App Security Informationen' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35755' frameborder='no'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35755" target="_blank">Auf einer neuen Registerkarte anzeigen</a>

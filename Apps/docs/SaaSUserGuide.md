...
![Auswählen einer App im kommerziellen Marketplace](../media/NewPCOffersOffice.png)
...
![App-Compliance im kommerziellen Marketplace](../media/PCappcompliance3.png)
  
**Schritt 4**: Ausfüllen des Selbstbewertungsfragebogens für Publisher Nachweis.

![Abschließen des Herausgebernachweises](../media/UserGuidePhotos/5.5.png)
...
![Exportfeature importieren](../media/UserGuidePhotos/06.png)
 
**Schritt 5**: Klicken Sie nach Abschluss auf "Absenden", die Bewertung lautet nun "Überprüft".
 
 ![Absenden Publisher](../media/UserGuidePhotos/07.png) ![Bestätigung der Übermittlung](../media/UserGuidePhotos/08.png)
...
![Beispiel für genehmigten Kontakt](../media/UserGuidePhotos/12.png)
...
![Zertifizierung starten Microsoft 365](../media/UserGuidePhotos/13.png) 
...
![Ursprüngliche DokumentübermittlungSubmit](../media/UserGuidePhotos/14.png) 
![ der ursprünglichen Dokumentübermittlung](../media/UserGuidePhotos/15.png)
...
![anforderungen für Hochladen-Steuerelemente](../media/UserGuidePhotos/19.png)
...
![Nachweise müssen aktualisiert werden](../media/UserGuidePhotos/22.png)

![Welche Steuerelemente aktualisiert werden müssen](../media/UserGuidePhotos/23.png)
  
![Überprüfung wird ausgeführt](../media/UserGuidePhotos/24.png) 
...
![Zum Nachweis verlängern](../media/UserGuidePhotos/29.png)
  
**Publisher Verlängerung des Nachweises genehmigt:**
  
![Zur Verlängerung einreichen](../media/UserGuidePhotos/30.png)
...
![Verlängerung des Nachweises](../media/UserGuidePhotos/32.png) 
...
![Zertifizierungsverlängerung](../media/UserGuidePhotos/33.png) 
...
![Zertifizierungsverlängerungsgenehmigung](../media/UserGuidePhotos/35.png)
...
![Zertifizierungsverlängerungsgenehmigung](../media/UserGuidePhotos/36.png)

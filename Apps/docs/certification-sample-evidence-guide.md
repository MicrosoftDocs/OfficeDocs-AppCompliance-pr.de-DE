...
ms.author: oromalle
manager: tonybal
description: Microsoft 365 Beispielhandbuch für die Übermittlung von Zertifizierungsnachweisen
...
![Screenshot der Antiviren- und Schadsoftwarerichtlinie](../media/UserGuidePhotos/Control-No-1.png)
...
![Screenshot von Azure Security Center; es zeigt, dass eine Antischadsoftwareerweiterung auf dem virtuellen Computer bereitgestellt wurde](../media/UserGuidePhotos/Control-No-2.png)
...
![screenshot shows Microsoft Defender updating at least daily by showing "Event 2000, Windows Defender"](../media/UserGuidePhotos/Control-No-3.png)
...
![Screenshot listet die genehmigten Anwendungen mit geschäftlicher Begründung auf.](../media/UserGuidePhotos/Control-No-7.png)
...
![screenshot lists the control mechanism used to implement the application control.](../media/UserGuidePhotos/Control-No-8.png)
...
![screenshot shows a Gruppenrichtlinie object with Software Restriction Policies enabled.](../media/UserGuidePhotos/Control-No-9.png)

Dieser nächste Screenshot zeigt die Konfiguration entsprechend dem obigen Steuerelement.

![screenshot shows the configuration in line with the control above.](../media/UserGuidePhotos/Control-No-9-1.png)
...
![screenshot shows the M365 Environment and the Computers included within the scope being applied to this GPO Object 'Domain Computer Einstellungen'.](../media/UserGuidePhotos/Control-No-9-2.png)
...
![screenshot shows the in-scope server "DBServer1" being within the OU within the screenshot above.](../media/UserGuidePhotos/Control-No-9-3.png)

### <a name="patch-management--risk-ranking"></a>Patch-Management – Risikorangfolge
...
![screenshot shows a snippet of a risk ranking policy.](../media/UserGuidePhotos/Control-No-10.png)
...
![Screenshot zeigt, dass eine Mailinggruppe verwendet wird, um über Sicherheitslücken benachrichtigt zu werden.](../media/UserGuidePhotos/Control-No-11.png)
...
![Nachweise für eine erneute Einstufung von Risikobewertungen müssten als nachweisende Nachweise vorgelegt werden.](../media/UserGuidePhotos/Control-No-12.png)
...
![Screenshot einer Kopie aller Richtlinien und Verfahren, die den Prozess für die Patchverwaltung detailliert darstellen. ](../media/UserGuidePhotos/Control-No-13.png)
...
![screenshot shows that the in scope system component "CLARANET-SBU-WM" is durchführung Windows updates in line with the patching policy.](../media/UserGuidePhotos/Control-No-14.png)
...
![Nachweise zeigen, dass auf der bereichsbezogenen Systemkomponente THOR Software ausgeführt wird, die vom Anbieter unterstützt wird, da Nessus keine Probleme gekennzeichnet hat.](../media/UserGuidePhotos/Control-No-15.png)
...
![screenshot shows that the in-scope system component "CLARANET-SBU-WM" is running on a supported Windows version.](../media/UserGuidePhotos/Control-No-15-1.png)
...
![screenshot is of the Trivy output, which the complete report doesn't list any unsupported applications.](../media/UserGuidePhotos/Control-No-15-2.png)
...
![screenshot shows a Nessus scan of the in-scope environment (a single machine in this example named "THOR") showing vulnerabilities on the 2nd August 2021.](../media/UserGuidePhotos/Control-No-17.png)
...
![screenshot shows that the issues were resolved, 2 days later which is within the patching window defined within the patching policy.](../media/UserGuidePhotos/Control-No-17-1.png)
...
![Beispiel für die Art des von uns benötigten Firewallrichtliniendokuments](../media/UserGuidePhotos/Control-No-18.png)

![Beispiel für die Art des Firewallrichtliniendokuments, für das 2 erforderlich ist](../media/UserGuidePhotos/Control-No-18-1.png)
...
![Screenshot der WatchGuard-Firewallregelbasis](../media/UserGuidePhotos/Control-No-23.png)
...
![screenshot shows the output of SSLScan against the Web Admin interface of the WatchGuard firewall on TCP port 8080.](../media/UserGuidePhotos/Control-No-24.png)
...
![screenshot shows evidence of a Firewall review taking place in Jan 2021.](../media/UserGuidePhotos/Control-No-25.png)

Der folgende Screenshot zeigt Beweise für eine Firewallüberprüfung, die im Juli 2021 stattfindet.

![screenshot shows evidence of a Firewall review taking place in July 2021.](../media/UserGuidePhotos/Control-No-25-1.png)
...
![screenshots shows the Contoso Production Azure Application Gateway WAF policy is enabled and that it is configured for 'Prevention' mode](../media/UserGuidePhotos/Control-No-26.png)

Der folgende Screenshot zeigt die Frontend-IP-Konfiguration

![Screenshot der Front-End-IP-Konfiguration](../media/UserGuidePhotos/Control-No-26-1.png)
...
![Screenshot der eingehenden Webverbindungen mit diesem WAF](../media/UserGuidePhotos/Control-No-26-2.png)
...
![screenshot shows that the Contoso Production Azure Application Gateway WAF policy is configured to scan against the OWASP Core Rule Set Version 3.2.](../media/UserGuidePhotos/Control-No-28.png)

### <a name="change-control"></a>Steuerelement ändern
...
![der Beginn einer Beispielrichtlinie für die Änderungsverwaltung.](../media/UserGuidePhotos/Control-No-29.png)
...
![screenshot shows an Azure subscription for Contoso&#39;s TEST environment.](../media/UserGuidePhotos/Control-No-30.png)
...
![screenshot shows the top 3 records from the Production Database.](../media/UserGuidePhotos/Control-No-31.png)

Der nächste Screenshot zeigt dieselbe Abfrage aus der Entwicklungsdatenbank mit unterschiedlichen Datensätzen.

![screenshot shows the same query from the Development Database, showing different records.](../media/UserGuidePhotos/Control-No-31-1.png)
...
![eine neue Sicherheitsanfälligkeit für websiteübergreifendes Skripting (Cross Site Scripting Vulnerability, XSS) zugewiesen und zur Änderungsanforderung dokumentieren.](../media/UserGuidePhotos/Control-No-32.png)
...
![Der Screenshot zeigt tickets show the information that has been set or added to the ticket on its journey to being resolved.](../media/UserGuidePhotos/Control-No-32-1.png) ![Der Screenshot zeigt tickets show the information that has been set or added to the ticket on its journey to being resolved.](../media/UserGuidePhotos/Control-No-32-2.png)
...
![Beispiel für eine Person, die die Arbeit](../media/UserGuidePhotos/Control-No-32-3.png)
![ ausführtExample einer anderen Person, die die Arbeit genehmigt](../media/UserGuidePhotos/Control-No-32-4.png)
...
![screenshot shows an example Jira ticket showing that the change needs to be authorized before being implemented and approved by someone other than the developer/requester.](../media/UserGuidePhotos/Control-No-33.png)
...
![Screenshot des abgeschlossenen Tickets](../media/UserGuidePhotos/Control-No-33-1.png)

![Screenshot des abgeschlossenen Tickets 2](../media/UserGuidePhotos/Control-No-33-2.png)
...
![Screenshot eines Auszugs aus dem Entwicklungsverfahren für sichere Software von Contoso&#39;](../media/UserGuidePhotos/Control-No-34.png)

![Screenshot eines Auszugs aus Contoso&#39;Secure Software Development Procedure 2](../media/UserGuidePhotos/Control-No-34-1.png)

![Screenshot eines Auszugs aus Contoso&#39;Secure Software Development Procedure 3](../media/UserGuidePhotos/Control-No-34-2.png)

![Screenshot eines Auszugs aus dem Entwicklungsverfahren für sichere Software von Contoso&#39;4](../media/UserGuidePhotos/Control-No-34-3.png)
...
![Die Codeüberprüfung wurde einer anderen Person als dem ursprünglichen Entwickler zugewiesen.](../media/UserGuidePhotos/Control-No-35-1.png)

![Ticket muss nun von einem Vorgesetzten genehmigt werden, bevor die Änderungen auf Live-Produktionssystemen platziert werden können.](../media/UserGuidePhotos/Control-No-35-2.png) Die abbildung oben zeigt, dass der überprüfte Code die Genehmigung erhalten hat, auf den Live-Produktionssystemen implementiert zu werden.

![Beispiel für die endgültige Genehmigung](../media/UserGuidePhotos/Control-No-35-3.png) Nachdem die Codeänderungen vorgenommen wurden, wird die endgültige Aufgabe wie in der Abbildung oben dargestellt abgemeldet.
...
![E-Mail-Anforderung, dass Mitarbeiter im DevOps-Team bei OWASP Top Ten Training Annual Training registriert werden](../media/UserGuidePhotos/Control-No-36.png)
...
![Die Schulung wurde mit geschäftlicher Begründung und Genehmigung angefordert.](../media/UserGuidePhotos/Control-No-36-1.png)
...
![screenshot shows members of the "Customers" project in GitLab which is the Contoso "Customer Portal"](../media/UserGuidePhotos/Control-No-38.png)
...
![Screenshot zeigt ein Beispiel für eine Kontoverwaltungsrichtlinie für Contoso.](../media/UserGuidePhotos/Control-No-39.png)

![screenshot shows more detials of an Account Management Policy for Contoso.](../media/UserGuidePhotos/Control-No-39-1.png)
...
![Der folgende Screenshot zeigt Benutzerkonten, die für die bereichsbezogene Systemkomponente "CLARANET-SBU-WM" konfiguriert sind. ](../media/UserGuidePhotos/Control-No-40.png)
...
![screenshot shows the Administrator account is disabled on the in-scope system component "CLARANET-SBU-WM".](../media/UserGuidePhotos/Control-No-40-1.png)
...
![screenshot shows the Guest account is disabled on the in-scope system component "CLARANET-SBU-WM".](../media/UserGuidePhotos/Control-No-40-2.png)
...
![Beispiel für die Kontoerstellung](../media/UserGuidePhotos/Control-No-41.png)

![Abmeldevorgang im Ticket](../media/UserGuidePhotos/Control-No-41-1.png)
...
![Beispiel für die Deaktivierung des Benutzers](../media/UserGuidePhotos/Control-No-42-1.png)
...
![die Kennwortrichtlinie, die in der "lokalen Sicherheitsrichtlinie" der in-Scope-Systemkomponente "CLARANET-SBU-WM" konfiguriert ist.](../media/UserGuidePhotos/Control-No-43.png)

![Ein weiteres Beispiel für die In-Scope-Systemkomponente "CLARANET-SBU-WM" in der "Lokalen Sicherheitsrichtlinie" konfigurierte Kennwortrichtlinie.](../media/UserGuidePhotos/Control-No-43-1.png)

Der folgende Screenshot zeigt die Kontosperrungseinstellungen für eine WatchGuard-Firewall.

![Kontosperreinstellungen für eine WatchGuard-Firewall](../media/UserGuidePhotos/Control-No-43-2.png)
...
![screenshot shows user accounts configured for the in-scope system component "CLARANET-SBU-WM".](../media/UserGuidePhotos/Control-No-44.png)

Dieser nächste Screenshot zeigt, dass das Administratorkonto in der bereichsbezogenen Systemkomponente &quot;CLARANET-SBU-WM&quot; deaktiviert ist.

![screenshot shows the Administrator account is disabled on the in-scope system component "CLARANET-SBU-WM".](../media/UserGuidePhotos/Control-No-44-1.png)

Dieser nächste Screenshot zeigt, dass das Gastkonto in der bereichsbezogenen Systemkomponente &quot;CLARANET-SBU-WM&quot; deaktiviert ist.

![screenshot shows the Guest account is disabled on the in-scope system component "CLARANET-SBU-WM".](../media/UserGuidePhotos/Control-No-44-2.png)
...
![screenshot shows that the environment is configured with groups assign according to job function.](../media/UserGuidePhotos/Control-No-45.png)
...
![ screenshot shows the 'Account is sensitive and connect be delegated' option is selected on the service account "_Prod SQL Service Account".](../media/UserGuidePhotos/Control-No-46.png)
...
![screenshot shows that the service account "_Prod SQL Service Account" is locked down to the SQL Server and can only log to that server.](../media/UserGuidePhotos/Control-No-46-1.png)
...
![screenshots shows the authentication realms configured on Pulse Secure which is used for remote access into the environment.](../media/UserGuidePhotos/Control-No-47.png)
...
![Screenshot zeigt, dass ein zusätzlicher Authentifizierungsserver aktiviert ist, der auf "Duo-LDAP" für den Authentifizierungsbereich "Duo - Standardroute" zeigt.](../media/UserGuidePhotos/Control-No-47-1.png)
...
![screenshot shows the configuration for the Duo-LDAP authentication server which demonstrates that this is pointing to the Duo SaaS service for MFA.](../media/UserGuidePhotos/Control-No-47-2.png)

Beispielbeweis 2: Die folgenden Screenshots zeigen, dass alle Azure-Benutzer MFA aktiviert haben.

![zeigen Sie an, dass für alle Azure-Benutzer MFA aktiviert ist.](../media/UserGuidePhotos/Control-No-47-3.png)
...
![Der folgende Nachweis zeigt die RDP-Verschlüsselungsstufe auf "Webserver01", die mit der Einstellung "High Level" konfiguriert wird.](../media/UserGuidePhotos/Control-No-48.png)
...
![screenshot show the contoso.com DNS is managed within Microsoft Azure for Contoso Corporation.](../media/UserGuidePhotos/Control-No-49.png)
...
![Screenshots zeigen, dass für alle Azure-Benutzer MFA aktiviert ist.](../media/UserGuidePhotos/Control-No-49-1.png)
...
![screenshot shows the IDPS functionality is enabled on the WatchGuard Firewall.](../media/UserGuidePhotos/Control-No-50.png)
...
![Screenshot zeigt, dass die neueste Version von IDPS installiert ist](../media/UserGuidePhotos/Control-No-51.png)
...
![Screenshot der HTTPS-Regeln in der Firewall](../media/UserGuidePhotos/Control-No-52.png)

Dieser nächste Screenshot zeigt, dass IDPS für diese Regeln aktiviert ist.

![Screenshot zeigt, dass IDPS für diese Regeln aktiviert ist.](../media/UserGuidePhotos/Control-No-52-1.png)
...
![screenshot shows a "Proxy Action" is applied to the 'Inbound_Bot_Traffic' rule, which is used to turn on content inspection.](../media/UserGuidePhotos/Control-No-52-2.png)
...
![screenshot shows that IDPS is configured on all the WatchGuard Firewall's rules (policies).](../media/UserGuidePhotos/Control-No-54.png)
...
![Netwatcher-Paketerfassung wurde zum Erfassen von Paketen verwendet und zusammen mit Suricata verwendet, einem Open-Source IDS-Tool.](../media/UserGuidePhotos/Control-No-54-1.png)
...
![Abbildung der Suricata-Schnittstelle.](../media/UserGuidePhotos/Control-No-54-2.png)
...
![Abbildung zeigt eine Momentaufnahme einiger Signaturen.](../media/UserGuidePhotos/Control-No-54-3.png)
...
![Abbildung zeigt, wie Sie Ihre IDPS-Einrichtung von Netwatcher- und Suricata-Drittanbietersoftware mit Sentinel SIEM/SOAR überwachen würden.](../media/UserGuidePhotos/Control-No-54-4.png)

![Abbildung zeigt weitere Details dazu, wie Sie Ihre IDPS-Einrichtung von Netwatcher- und Suricata-Drittanbietersoftware mit Sentinel SIEM/SOAR überwachen würden.](../media/UserGuidePhotos/Control-No-54-5.png)
...
![Abbildung zeigt, wie Sie eine Überschreibungs-Angriffssignatur oder eine Umgehungsregel für die Angriffserkennung mithilfe von CLI hinzufügen](../media/UserGuidePhotos/Control-No-54-6.png)

Die folgende Abbildung zeigt, wie sie alle Konfigurationen zur Angriffserkennung mithilfe von CLI auflisten.

![Abbildung zeigt, wie sie alle Konfigurationen zur Angriffserkennung mithilfe von CLI auflisten](../media/UserGuidePhotos/Control-No-54-7.png)
...
![Screenshot des IDPS-Modus aktiviert](../media/UserGuidePhotos/Control-No-54-8.png)

![Screenshot der aktivierten IDPS-Warnungen](../media/UserGuidePhotos/Control-No-54-9.png)

![Screenshot der aktivierten TLS-Überprüfung](../media/UserGuidePhotos/Control-No-54-10.png)

![Screenshot der aktivierten Bedrohungserkennung](../media/UserGuidePhotos/Control-No-54-11.png)

![Screenshot von DLS aktiviert](../media/UserGuidePhotos/Control-No-54-12.png)

![Screenshot gesicherter virtueller Netzwerke](../media/UserGuidePhotos/Control-No-54-13.png)
...
![aus der Protokollierungsrichtlinie/-prozedur extrahieren.](../media/UserGuidePhotos/Control-No-55.png)
...
![Der folgende Screenshot zeigt die Konfigurationseinstellungen von einem der beispielbasierten Geräte namens "VICTIM1-WINDOWS".](../media/UserGuidePhotos/Control-No-56.png)
...
![screenshot shows the log message appear within the centralized logging solution.](../media/UserGuidePhotos/Control-No-56-2.png)
...
![Der folgende Screenshot zeigt die Informationen aus den Sicherheitsereignissen in Windows Ereignisanzeige aus der bereichsinternen Systemkomponente "SEGSVR02".](../media/UserGuidePhotos/Control-No-57.png)
...
![Diagramm zeigt die verwendete Zeitsynchronisierungstopologie.](../media/UserGuidePhotos/Control-No-58.png)
...
![screenshot shows the WatchGuard configured as an NTP Server and pointing to time.windows.com as it's time source.](../media/UserGuidePhotos/Control-No-58-1.png)
...
![zeigt den "nxlog"-Dienst, der auf der DMZ-Jumpbox "DESKTOP-7S65PN" ausgeführt wird, die zum Verwalten aller DMZ-Server verwendet wird.](../media/UserGuidePhotos/Control-No-59.png)
...
![Screenshot eines Extrakts aus der Datei nxlog.conf](../media/UserGuidePhotos/Control-No-59-1.png)
...
![screenshots shows that 30days worth of logs are available within AlienVault.](../media/UserGuidePhotos/Control-No-61.png)
...
![screenshot shows that logs are available by showing a log extract going back 5 months.](../media/UserGuidePhotos/Control-No-61-1.png)
...
![screenshot shows that log events are kept for 30 days available live and 90 days in cold storage within Azure.](../media/UserGuidePhotos/Control-No-61-2.png)

### <a name="reviewing-security-event-logging-data"></a>Überprüfung (Sicherheitsereignisprotokollierungsdaten)
...
![ein Auszug aus der Richtlinie/Prozedur zur Protokollüberprüfung.](../media/UserGuidePhotos/Control-No-62.png)
...
![screenshot identifies where a user has been added to the "Domain Admins" group.](../media/UserGuidePhotos/Control-No-63.png)
...
![screenshot identifies where multiple failed logon attempts are then followed by a successful login which may highlight a successful brute force attack.](../media/UserGuidePhotos/Control-No-63-1.png)
...
![screenshot identifies where a password policy change has occurred setting the policy, so account passwords don't expire.](../media/UserGuidePhotos/Control-No-63-2.png)
...
![screenshot example shows a security alert being tracked within ServiceNow by the Claranet Cyber Security MDR (Managed Detection and Response) SOC.](../media/UserGuidePhotos/Control-No-64.png)
...
![screenshot shows confirmation that this has been resolved by David Ashton @ Contoso through an update within the ServiceNow customer portal.](../media/UserGuidePhotos/Control-No-64-1.png)
...
![ein Auszug aus der Richtlinie/Prozedur für Warnungen zu Sicherheitsereignissen.](../media/UserGuidePhotos/Control-No-65.png)
![ ein erweiterter Auszug aus der Richtlinie/Prozedur zur Warnung für Sicherheitsereignisse.](../media/UserGuidePhotos/Control-No-65-1.png)
...
![screenshot shows an on-call rota for December 2020 for Contoso.](../media/UserGuidePhotos/Control-No-67.png)
...
![Der folgende Nachweis ist ein Screenshot eines Teils des Risikobewertungsprozesses von Contoso.](../media/UserGuidePhotos/Control-No-68.png)

![Der folgende Nachweis ist ein Screenshot des erweiterten Teils des Risikobewertungsprozesses von Contoso.](../media/UserGuidePhotos/Control-No-68-1.png)
...
![screenshot shows a risk assessment meeting being scheduled for every six months.](../media/UserGuidePhotos/Control-No-69.png)

Diese beiden Screenshots zeigen die Besprechungsprotokolle aus zwei Besprechungen zur Risikobewertung.

![screenshot show the meeting minutes from two risk assessment meeting.](../media/UserGuidePhotos/Control-No-69-1.png)
...
![screenshot shows the risk register which demonstrates threats and vulnerabilities are included.](../media/UserGuidePhotos/Control-No-70.png)
...
![Risikoregister für Contoso.](../media/UserGuidePhotos/Control-No-72.png)

**Hinweis:** Die vollständige Dokumentation zur Risikobewertung sollte anstelle eines Screenshots bereitgestellt werden.

Der folgende Screenshot zeigt einen Risikobehandlungsplan.

![Screenshot zeigt einen Risikobehandlungsplan.](../media/UserGuidePhotos/Control-No-72-1.png)
...
![screenshot shows the start of Contoso's incident response plan.](../media/UserGuidePhotos/Control-No-73.png)
...
![screenshot shows an extract from the incident response report generated by Claranet for Contoso1](../media/UserGuidePhotos/Control-No-75.png)

![screenshot shows an extract from the incident response report generated by Claranet for Contoso2](../media/UserGuidePhotos/Control-No-75-1.png)

![screenshot shows an extract from the incident response report generated by Claranet for Contoso3](../media/UserGuidePhotos/Control-No-75-2.png)
...
![screenshots are from the supplied IRP based on lessons learned and/or organization changes1](../media/UserGuidePhotos/Control-No-76.png)

![screenshots are from the supplied IRP based on lessons learned and/or organization changes2](../media/UserGuidePhotos/Control-No-76-1.png)

Das IRP-Änderungsprotokoll zeigt ein Update auf der Rückseite der Tabletop-Übung, die im Juli 2021 durchgeführt wurde.

![screenshots are from the supplied IRP based on lessons learned and/or organization changes3](../media/UserGuidePhotos/Control-No-76-2.png)

## <a name="security-domain-data-handling-security-and-privacy"></a>Sicherheitsdomäne: Datensicherheit und Datenschutz
...
- Beispielnachweis: Der folgende Screenshot zeigt die Ergebnisse für den [](http://www.clara.net:443/) www.clara.net:443-Weblistener.

![screenshot shows the results for theclaranet web listener1](../media/UserGuidePhotos/Security-Domain-Control-No-1.png)

![screenshot shows the results for theclaranet web listener2](../media/UserGuidePhotos/Security-Domain-Control-No-1-1.png)
...
![Screenshot zeigt, dass TLS 1.2 auf dem Speicher konfiguriert ist1](../media/UserGuidePhotos/Security-Domain-Control-No-1-2.png)
...
![Screenshots zeigen, dass TLS V1.3 nur auf dem Server aktiviert ist](../media/UserGuidePhotos/Security-Domain-Control-No-1-3.png)
...
![Screenshot zum Anzeigen einer anderen Möglichkeit, um anzuzeigen, ob TLS aktiviert oder deaktiviert ist1](../media/UserGuidePhotos/Security-Domain-Control-No-1-4.png)

![Screenshot mit einer anderen Möglichkeit, um anzuzeigen, ob TLS aktiviert oder deaktiviert ist2](../media/UserGuidePhotos/Security-Domain-Control-No-1-5.png)
...
![Screenshot zeigt Nachweise über das Qualys SSL Labs-Tool oder andere Tools und Webbrowser-Add-Ins](../media/UserGuidePhotos/Security-Domain-Control-No-3.png)

### <a name="data-at-rest"></a>Ruhedaten
...
![Screenshot zeigt, dass TDE (Transparent Data Encryption) in der Contoso-Datenbank aktiviert ist](../media/UserGuidePhotos/Security-Domain-Control-No-4.png)

![Screenshot zeigt, dass die AES 256-Verschlüsselung für Azure TDE verwendet wird](../media/UserGuidePhotos/Security-Domain-Control-No-4-1.png)
...
![Screenshot der Azure Storage, die mit Verschlüsselung für Blobs und Dateien konfiguriert sind ](../media/UserGuidePhotos/Security-Domain-Control-No-4-2.png)
...
![screenshot shows an example of what a document showing data types could look like](../media/UserGuidePhotos/Security-Domain-Control-No-6.png)
...
![Screenshot unten zeigt die Datenaufbewahrungsrichtlinie von Contoso1](../media/UserGuidePhotos/Security-Domain-Control-No-7.png)

![Screenshot unten zeigt die Datenaufbewahrungsrichtlinie von Contoso2](../media/UserGuidePhotos/Security-Domain-Control-No-7-1.png)
...
![Screenshot einer SQL Abfrage mit dem Inhalt der In aufsteigenden Reihenfolge sortierten Datenbanktabelle](../media/UserGuidePhotos/Security-Domain-Control-No-8.png)
...
![Screenshot des Skripts, das zum Löschen aller Datensätze verwendet werden kann, die basierend auf dem Datum aufbewahrt werden](../media/UserGuidePhotos/Security-Domain-Control-No-9.png)
...
![Screenshot des Contoso-Datenaufbewahrungsplans in Steuerelement 7](../media/UserGuidePhotos/Security-Domain-Control-No-9-1.png)
...
![Screenshot des Runbook für die Datenaufbewahrung](../media/UserGuidePhotos/Security-Domain-Control-No-9-2.png)
...
![Screenshot zeigt, dass das Runbook bearbeitet wurde, um Datensätze zu suchen, und dass Löschbefehle nicht wie das Skript1 angezeigt werden.](../media/UserGuidePhotos/Security-Domain-Control-No-9-3.png)

![Screenshot zeigt, dass das Runbook bearbeitet wurde, um Datensätze zu suchen, und dass Löschbefehle nicht wie das Skript1 angezeigt werden.](../media/UserGuidePhotos/Security-Domain-Control-No-9-4.png)
...
![Screenshot, der zeigt, dass eine Anforderung in Jira erstellt wurde, um die Sam Daily-Genehmigung für Verschlüsselungsschlüssel in der Back-End-Umgebung des Systems zu erhalten1](../media/UserGuidePhotos/Security-Domain-Control-No-11.png)

![Screenshot, der zeigt, dass eine Anforderung in Jira erstellt wurde, um die Sam Daily-Genehmigung für Verschlüsselungsschlüssel auf dem System-Back-End environmen2 zu erhalten](../media/UserGuidePhotos/Security-Domain-Control-No-11-1.png)
...
![Screenshot zeigt, dass die Anforderung, Sam Daily Zugriff zu gewähren, von Jon Smith einer Person aus der Geschäftsleitung genehmigt wurde](../media/UserGuidePhotos/Security-Domain-Control-No-11-2.png)
...
![Screenshot eines Workflows in Jira](../media/UserGuidePhotos/Security-Domain-Control-No-11-3.png)
...
![Screenshot, der zeigt, dass die Genehmigung für Sam Daily erteilt wurde](../media/UserGuidePhotos/Security-Domain-Control-No-11-4.png)
...
![Genehmigungsprozess1](../media/UserGuidePhotos/Security-Domain-Control-No-11-5.png)

![Genehmigungsprozess2](../media/UserGuidePhotos/Security-Domain-Control-No-11-6.png)

![Genehmigungsprozess3](../media/UserGuidePhotos/Security-Domain-Control-No-11-7.png)
...
![Beispiel-E-Mail1](../media/UserGuidePhotos/Security-Domain-Control-No-13.png)

![Beispiel-E-Mail2](../media/UserGuidePhotos/Security-Domain-Control-No-13-1.png)
...
![Screenshot einer einfachen Beispielvereinbarung für die Datenfreigabe1](../media/UserGuidePhotos/Security-Domain-Control-No-14.png)

![Screenshot einer einfachen Beispielvereinbarung für die Datenfreigabe2](../media/UserGuidePhotos/Security-Domain-Control-No-14-1.png)
...
![Screenshot eines dokumentierten Prozesses für die Behandlung von SARs](../media/UserGuidePhotos/Security-Domain-Control-No-16.png)
...
![screenshot is a snippet from the above SAR's procedure which shows how data will be found.](../media/UserGuidePhotos/Security-Domain-Control-No-17.png)
...
![Screenshot, der zeigt, wie die ISV-Datenspeicherorte abgefragt wurden1](../media/UserGuidePhotos/Security-Domain-Control-No-17-1.png)

![Screenshot, der zeigt, wie die ISV-Datenspeicherorte abgefragt wurden2](../media/UserGuidePhotos/Security-Domain-Control-No-17-2.png)
...
![Screenshot, der zeigt, wie die ISV-Datenspeicherorte abgefragt wurden3](../media/UserGuidePhotos/Security-Domain-Control-No-17-4.png)

![Screenshot, der zeigt, wie die ISV-Datenspeicherorte abgefragt wurden4](../media/UserGuidePhotos/Security-Domain-Control-No-17-5.png)
...
![Screenshot der Datenschutzerklärung von Contoso 1](../media/UserGuidePhotos/Security-Domain-Control-No-18.png)

![Screenshot der Datenschutzerklärung von Contoso 2](../media/UserGuidePhotos/Security-Domain-Control-No-18-1.png)
...
![Screenshot der Datenschutzerklärung von Contoso 3](../media/UserGuidePhotos/Security-Domain-Control-No-18-2.png)
...
![Screenshot der Datenschutzrichtlinie, die in Verbindung mit dem zuvor gezeigten Datenschutzhinweis verwendet werden kann1](../media/UserGuidePhotos/Security-Domain-Control-No-18-3.png)

![Screenshot der Datenschutzrichtlinie, die in Verbindung mit dem zuvor gezeigten Datenschutzhinweis verwendet werden kann2](../media/UserGuidePhotos/Security-Domain-Control-No-18-4.png)

![Screenshot der Datenschutzrichtlinie, die in Verbindung mit dem zuvor gezeigten Datenschutzhinweis verwendet werden kann3](../media/UserGuidePhotos/Security-Domain-Control-No-18-5.png)

...
description: Alle verfügbaren Sicherheits- und Complianceinformationen für SlideHub, seine Datenverarbeitungsrichtlinien, seine Microsoft Cloud App Security App-Kataloginformationen und Sicherheits-/Complianceinformationen in der CSA STAR-Registrierung.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001625" target="_blank">Anzeigen in AppSource</a>
...
| Website des Unternehmens | [https://nomorehours.com](https://nomorehours.com) |
| Nutzungsbedingungen der App | [https://nomorehours.com/eula](https://nomorehours.com/eula) |
| Kernfunktionen der App | NoMore bietet Geschäftsbenutzern PowerPoint Designdienste und ein PowerPoint-Add-In, um sie in PowerPoint effizienter zu machen. Im Rahmen des Entwurfsdiensts konvertiert NoMore grobe Entwürfe in nur 8 Stunden in clientfähige Folien. Das Add-In hilft, schneller auf den Dienst zuzugreifen, ermöglicht benutzern aber auch den Zugriff auf vorgefertigte Foliendesigns und eine unternehmensspezifische Folienbibliothek sowie ein &#8220;Consulting Toolkit&#8221;, das verschiedene Produktivitätstools enthält. |
| Hauptsitz des Unternehmens | Dänemark |
| App-Infoseite | [https://nomorehours.com](https://nomorehours.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Anwendung | E-Mail und Name. Die E-Mail wird als Benutzername in der Anwendung verwendet. Das Sammeln der E-Mail kann dazu beitragen, sich schneller bei der Anwendung anzumelden. Der Name wird bei einem Registrierungsereignis verwendet. | [33ccef75-8248-44e8-88d3-24526ca9c2d3](../azure/33ccef75-8248-44e8-88d3-24526ca9c2d3.md) |
